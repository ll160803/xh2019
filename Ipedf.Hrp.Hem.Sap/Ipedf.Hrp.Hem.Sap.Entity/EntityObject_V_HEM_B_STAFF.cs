...
{
	[Serializable]
	[DataObject("V_HEM_B_STAFF")]
	public partial class CauseObject_V_HEM_B_STAFF:CauseBase
	{
        ...
        System.Decimal _IS_STANDARD = ConstLibrary.Template.UndefineDecimal;

        public System.Decimal IS_STANDARD { get { return _IS_STANDARD; } set { _IS_STANDARD = value; } }

        System.Decimal _IS_SZHY = ConstLibrary.Template.UndefineDecimal;
	...
	[Serializable]
	public partial class DisplayObject_V_HEM_B_STAFF:EntityObject_V_HEM_B_STAFF
	{
		#region Attribute Block
	...
	[Serializable]
	public partial class EntityObject_V_HEM_B_STAFF:EntityBase
	{
		#region Attribute Block
