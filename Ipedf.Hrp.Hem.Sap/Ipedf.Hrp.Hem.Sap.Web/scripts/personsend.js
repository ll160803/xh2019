$(function(){
	...
	var tableDiv5 = "<span class='tableSq' style='display:none;'><a href='STAFF_FILEUPLOAD.aspx'>简历上传</a></span>";
	$(".tableL").append(tableDiv1).append(tableDiv2).append(tableDiv3).append(tableDiv4).append(tableDiv5);
