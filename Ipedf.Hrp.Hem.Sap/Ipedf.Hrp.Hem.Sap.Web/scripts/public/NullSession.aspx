<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NullSession.aspx.cs" Inherits="Ipedf.Hrp.Hem.Sap.Web.NullSession" %>
...
<body>
    ...
    <div class="container">
        <div class="row loginbg" id="mainbg" style="text-align:center;">
            ...
            <img src="../Images/Public/Asking.png" style="margin-top:6%;"/><br />
            <asp:LinkButton ID="lbt_Session" runat="server">会话已过期请重新登录</asp:LinkButton>
            </form>
        </div>
    </div>
    <div class="footer">
