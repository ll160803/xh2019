<%@ Page Language="C#" MasterPageFile="~/Controls/Manage.Master" AutoEventWireup="true"
    CodeBehind="RECRUIT_STAFF_LIST_PANDING.aspx.cs" Inherits="Ipedf.Hrp.Hem.Sap.Web.RECRUIT_STAFF_LIST_PANDING"
    Title="招聘广告-未处理" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Button ID="btn_YTG" class="Content2-btn btn btn-primary btn-sm" runat="server"
        OnClientClick="return confirm('确定要简历通过吗？')" Text="简历通过" OnClick="btn_YTG_Click" />&nbsp;
    <asp:Button ID="btn_YMS" class="Content2-btn btn btn-primary btn-sm" runat="server"
        OnClientClick="return confirm('确定要安排面试吗？')" Text="安排面试" OnClick="btn_YMS_Click" />&nbsp;
    <asp:Button ID="btn_YJJ" class="Content2-btn btn btn-primary btn-sm" runat="server"
        OnClientClick="return confirm('确定要拒绝简历吗？')" Text="拒绝简历" OnClick="btn_YJJ_Click" />&nbsp;
    <asp:Button ID="btn_YWC" class="Content2-btn btn btn-primary btn-sm" runat="server"
        OnClientClick="return confirm('确定已完成？')" Text="已完成" OnClick="btn_YWC_Click" />
