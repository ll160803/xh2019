<%@ Page Language="C#" MasterPageFile="~/Controls/Manage.Master" AutoEventWireup="true"
    CodeBehind="RECRUIT_POSTER_LIST_PCD.aspx.cs" Inherits="Ipedf.Hrp.Hem.Sap.Web.RECRUIT_POSTER_LIST_PCD"
    Title="招聘启事-已发布" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Button ID="btn_gq" class="Content2-btn btn btn-primary btn-sm" runat="server" Text="更新过期" onclick="btn_gq_Click" OnClientClick="return confirm('确定更新选中招聘启事为过期状态吗？')" />
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td width="8%" align="center">
                        <a href="<%#UrlPosterQuery(Eval("ID"),10)%>">
                            <div>
                                <%#Eval("ALLCOUNT")%>人</div>
                        </a>
                    </td>
                    <td width="9%" align="center">
                        <a href="<%#UrlPosterQuery(Eval("ID"),0)%>">
                            <div>
                                <%#Eval("WCL")%>人</div>
                        </a>
                    </td>
                    <td width="8%" align="center">
                        <a href="<%#UrlPosterQuery(Eval("ID"),1)%>">
                            <div>
                                <%#Eval("YTG")%>人</div>
                        </a>
                    </td>
                    <td width="5%" align="center">
                        <a href="<%#UrlPosterQuery(Eval("ID"),2)%>">
                            <div>
                                <%#Eval("YMS")%>人</div>
                        </a>
                    </td>
                    <td width="5%" align="center">
                        <a href="<%#UrlPosterQuery(Eval("ID"),3)%>">
                            <div>
                                <%#Eval("YJJ")%>人</div>
                        </a>
                    </td>
                    <td width="5%" align="center">
                        <a href="<%#UrlPosterQuery(Eval("ID"),4)%>">
                            <div>
                                <%#Eval("YWC")%>人</div>
                        </a>
                    </td>
                    <td width="12%" align="center">
                        ...
                        <asp:LinkButton ID="lkBen_Over" runat="server" OnClick="lkBen_Over_Click" OnClientClick="return confirm('确定更新此招聘启事为过期状态吗？')" CommandArgument='<%#Eval("ID")%>'>过期</asp:LinkButton>|
