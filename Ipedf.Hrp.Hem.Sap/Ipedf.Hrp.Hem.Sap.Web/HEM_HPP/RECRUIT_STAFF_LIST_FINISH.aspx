<%@ Page Language="C#" MasterPageFile="~/Controls/Manage.Master" AutoEventWireup="true"
    CodeBehind="RECRUIT_STAFF_LIST_FINISH.aspx.cs" Inherits="Ipedf.Hrp.Hem.Sap.Web.RECRUIT_STAFF_LIST_FINISH"
    Title="招聘广告-已完成" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Button ID="btn_SAP" class="Content2-btn btn btn-primary btn-sm" runat="server" OnClientClick="return confirm('确定要传输简历到SAP吗？')"
        Text="传输SAP" OnClick="btn_SAP_Click" /> &nbsp;
    ...
    申请职位：<asp:TextBox ID="txt_RECRUIT_POSITION" Width="150px" style="display:inline-block;" class="form-control" runat="server"></asp:TextBox>&nbsp;
    ...
    <div id="light" class="white_content alert"><div class="alert-wrapper">
        ...
        <div id="btnDIV" style="width: 50%; height: 5%;left:25%; border: 1px;position:absolute;bottom:2%;">
                ...
                <asp:Button ID="btnSAP" runat="server" Text="传输SAP" class="light_btn btn btn-primary btn-sm" OnClick="btnSAP_Click" OnClientClick="return confirm('确定要传输简历到SAP吗？')" />
