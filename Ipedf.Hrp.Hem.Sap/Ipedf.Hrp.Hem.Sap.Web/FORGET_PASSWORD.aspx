<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FORGET_PASSWORD.aspx.cs"
    Inherits="Ipedf.Hrp.Hem.Sap.Web.FORGET_PASSWORD" %>
                        ...
                        <div class="loginCenter">
                            <div class="pass-wrap clearfix">
                                ...
                                <div class="pass-right">
                                   <asp:TextBox ID="txtInputACCOUNT" runat="server"  class="form-control"></asp:TextBox>
                            ...
                            <div class="pass-wrap clearfix">
                                <label>验证码</label>
                                <div class="pass-right">
                                    <asp:TextBox ID="txt_YZM" runat="server" Style="width:74%;display:inline-block;" class="form-control"></asp:TextBox>
                                    <asp:Button ID="btn_Msg" runat="server" CausesValidation="false" Text="发送" class="btn btn-primary btn-sm btn-white" OnClick="btn_Msg_Click" />
                            ...
                            <div class="pass-wrap clearfix">
                            <a href="FORGET_PASSWORD1.aspx">海外用户密码找回</a>
                            </div>
                        </div>
