<%@ Page Language="C#" MasterPageFile="~/Controls/User.Master" AutoEventWireup="true" CodeBehind="STAFF_APPLY_LIST.aspx.cs" Inherits="Ipedf.Hrp.Hem.Sap.Web.STAFF_APPLY_LIST" Title="应聘信息" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(function(){
            $("#mainNav li:eq(2)").addClass("active").siblings().removeClass("active");
	...
	<div class="mainTable">
	    ...
	    <table class="table table-bordered table-header">
                            <tr>
					            ...
					            <td  align="center"><strong>申请日期</strong></td>
		            ...
		            <ItemTemplate>
				            <tr>
					            <td style="width:35%;text-align:center">
					                <asp:LinkButton ID="lbn_Apply" CommandName="APPLY" CommandArgument='<%# Eval("POSTER_ID") %>' runat="server"><%# Eval("TITLE") %></asp:LinkButton>
					            </td>
