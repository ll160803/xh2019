...
namespace Ipedf.App
{
    ...
    public interface ISCM_WCF
    {
        ...
        [OperationContract]
        MessModel SupplyPlan_MakeSure(string gyjh, string gysAccount, string gysName, string num, string amount);
        ...
        [OperationContract]
        MessModel SupplyPlan_MakeSureBatch(List<string> listCode);
