        ...
        <div style="padding: 10px 60px 20px 60px">
            ...
            <table cellpadding="5">
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" class="easyui-linkbutton" name="A19" id="A19" <%if(!string.IsNullOrEmpty(ViewBag.Name_19)){ %> style="display: none;"<%} %> onclick="UpLoad(19,'Span19','Hidden19','A19')">
                            上传附件</a><span id="Span19"><%:ViewBag.Name_19 %><% if (ViewBag.Edit == "1" &&!string.IsNullOrEmpty(ViewBag.Name_19)){%><a
                                href="#" onclick="deleteAttach('<%:ViewBag.ID_19 %>','Span19','Hidden19','A19')">删除</a><%} %></span><input id="Hidden19" type="hidden" name="Hidden19"
                            value="<%:ViewBag.ID_19 %>"    />
                    </td>
                </tr>

                 <tr>
                    <td class="fTd" id="lastDay1" <%if (string.IsNullOrEmpty(ViewBag.Name_19)) { %> style="display: none" <%} %> >
                        采购合同有效期：
                    </td>
                    <td id="nowDay1"  <%if (string.IsNullOrEmpty(ViewBag.Name_19)) { %> style="display: none" <%} %> >
