<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Create.Master" Inherits="System.Web.Mvc.ViewPage<Ipedf.Web.Entity.DisplayObject_COM_MODULE>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    $(function () {
        $("#SYSTEM_ID").combobox({
                url: '<%: Url.Content("~/System/Modules/GetAppDataForCombobox")%>',
				valueField:'value',
				textField:'text',
        });
