...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
     ...
     $(function(){
         $("#COMMENTS").combobox('setValue',"<%:Model.COMMENTS %>");
     });
     function submitForm() {
	        $('#ff').form('submit', {
	            url: "<%: Url.Content("~/System/SCM_B_SALERETURN/Edit/")%>",
                dataType: "json",
                onsubmit: function () {
                ...
                keyHandler: {
                 ...
                 onLoadSuccess:function(){
                       // $("#MATER_ID").combogrid("setText",);
                         if (!$("#MATNR_ID").combogrid('grid').datagrid('getSelected'))  //不再当前页
                          $("#MATNR_ID").next().find('input.combo-text').val('<%:ViewBag.MaterName %>');
                    }
            });
