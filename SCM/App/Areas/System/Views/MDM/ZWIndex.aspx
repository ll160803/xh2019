        ...
        <div style="margin-bottom: 5px">
            <%--<a href="#" class="easyui-linkbutton" iconcls="icon-save" plain="true" onclick="flexiSave();">
                保存</a>--%> <a href="#" class="easyui-linkbutton" iconcls="icon-save" plain="true" onclick="flexiSaveAudit();">
                    保存并通过审核</a> <a href="#" class="easyui-linkbutton" iconcls="icon-save" plain="true"
                        onclick="flexiCancel();">取消通过审核</a> <%--<a href="#" class="easyui-linkbutton" iconcls="icon-add"
...
$(function() {
    ...
    WCKJ.Format.EditGrid("flexigridData", "", '<%: Url.Content("~/System/MDM/GetData")%>', columns, {
        ...
        nowrap: false,
        striped: true,
        queryParams:{DEPT_TYPE_ID:'SCM00340002'},
        toolbar: '#tb',
        collapsible: false,
        //获取数据的url
        sortName: 'STATE',
