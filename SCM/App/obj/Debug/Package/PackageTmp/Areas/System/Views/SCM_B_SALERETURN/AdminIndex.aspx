...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="tb" style="padding: 5px; height: auto">
        ...
        <div>
        <a href="#" class="easyui-linkbutton" iconcls="icon-edit" plain="true" onclick="flexiModify();">
                    编辑</a> 
            <a href="#" class="easyui-linkbutton" iconcls="icon-edit" plain="true" onclick="Check(1);">
                返回提交</a><a href="#" class="easyui-linkbutton" iconcls="icon-edit" plain="true" onclick="Check(3);">
                    通过审核</a>  
        </div>
    </div>
</asp:Content>
