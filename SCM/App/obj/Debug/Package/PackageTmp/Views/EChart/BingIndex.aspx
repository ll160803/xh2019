...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#FaultTypeGuid').combotree({
                url: '../../WC_Renovation_FaultType/GetWC_Renovation_FaultTypeTrees/',
                width: '125',
                panelWidth: '300',
                valueField: 'id',
                textField: 'text'
        ...
        function GetFaultData() {
            ...
            $('#chart2').datagrid({
                ...
                striped: true,
                collapsible: true,
                url: '../../EChart/GetDateFaultType', //获取数据的url
                sortname: 'name',
                sortorder: 'desc',
                idfield: 'name',
                columns: [[
                ...
                queryParams: {
                    ...
                    FaultTypeGuid: $("#FaultTypeGuid").combotree('tree').tree('getSelected').id,
        ...
        function SearchQuery() {
            if ($("#FaultTypeGuid").combotree('tree').tree('getSelected').text == "全部") {
                $.messager.alert('操作提示', '请选择故障分类!', 'warning');
                return false;
            }
            GetChartData();
            GetFaultData();
...
<body class="easyui-layout">
    <div data-options="region:'north', title:'查询条件'" style="height:237px">
    <div id="searchbox" class="easyui-panel searchPannel" style="background: #fafafa; padding:3px 3px 3px 3px"data-options="iconCls:'icon-search',collapsible:true" >
        <table cellpadding="0;" cellspacing="0;">
            ...
            <tr>
                ...
                <td style=" padding-left: 41px; height:30px" class="td_T">
                    开始时间： &nbsp<input id="StartDate" name="FaultDate" type="text" class="easyui-datebox" />&nbsp&nbsp&nbsp&nbsp 结束时间： &nbsp<input id="EndDate" name="" type="text" class="easyui-datebox" />
                </td>
            </tr>
                            <td  class="td_T2">
                    故障分类：
                ...
                <td style=" padding-left: 41px; height:30px" class="td_T">
                    <input id="FaultTypeGuid" type="text" />
                </td>
            </tr>
            <tr>
                <td  class="td_F">
    ...
    <div data-options="region:'center'" id="divCenter">
        ...
        <div id="chartBreakYear" class="easyui-panel" title="故障类型详细" style="background: #fafafa;">
