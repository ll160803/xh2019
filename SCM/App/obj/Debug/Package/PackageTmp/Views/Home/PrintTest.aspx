...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function PrintPrintPage() {
            ...
            LODOP.ADD_PRINT_HTM(15, 6, $("#print").width(), $("#print").height(), document.getElementById("print").innerHTML);
...
<body style="margin: 0; border: 0; padding: 0;">
    ...
    <div id="print" style="border: 0px; width: 400px; position: absolute; top: 0px; left: 10px;">
        <%:ViewBag.PrintStr %>
    </div>
