...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="dlg" class="easyui-dialog" title="创建供应计划" data-options="iconCls:'icon-save',closed:true,"
    ...
    <script type="text/javascript" language="javascript">
        ...
        var columns = [
            [
                ...
                $(function () {
                    WCKJ.Format.baseGrid("flexigridData", "", '<%: Url.Content("~/XJ/SCM_B_PRICEADJUST/GetAdminData")%>', columns,
                         {
                             title: '药品价格调整', //列表的标题
                             iconCls: 'icon-site',
                             fit: true,
