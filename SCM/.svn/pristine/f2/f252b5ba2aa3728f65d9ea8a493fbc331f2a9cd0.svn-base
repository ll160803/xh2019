...
{
	[Serializable]
	[DataObject("V_SCM_B_QUOTEDPRICE")]
	public partial class CauseObject_V_SCM_B_QUOTEDPRICE:CauseBase
	{
	...
	[Serializable]
	public partial class DisplayObject_V_SCM_B_QUOTEDPRICE:EntityObject_V_SCM_B_QUOTEDPRICE
	{
		#region Attribute Block
	...
	[Serializable]
	public partial class EntityObject_V_SCM_B_QUOTEDPRICE:EntityBase
	{
		#region Attribute Block
