...
namespace Ipedf.Web.Entity
{
	[Serializable]
	[DataContract]
	[DataObject("SCM_D_SENDDEPART")]
	public partial class CauseObject_SCM_D_SENDDEPART:CauseBase
	{
	...
	[DataContract]
	[DataObject("SCM_D_SENDDEPART")]
	public partial class DisplayObject_SCM_D_SENDDEPART:EntityObject_SCM_D_SENDDEPART
	{
		#region Attribute Block
	...
	[DataContract]
	[DataObject("SCM_D_SENDDEPART")]
	public partial class EntityObject_SCM_D_SENDDEPART:EntityBase
	{
		#region Attribute Block
