<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Create.Master" Inherits="System.Web.Mvc.ViewPage<Ipedf.Web.Entity.DisplayObject_COM_FUNCTION>" %>
    ...
    <fieldset>
        ...
        <div class="laytrnew">
            ...
            <div class="centreside">
                ...
                <div class="trendrt">
                    <%: Html.EditorFor(model => model.MODULE_ID)%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
    <script language="javascript" type="text/javascript">
        $(function () {
            $("#MODULE_ID").combobox({
                url: '<%: Url.Content("~/System/PageModule/GetAppDataForCombobox")%>',
                valueField: 'value',
                textField: 'text'
            });
