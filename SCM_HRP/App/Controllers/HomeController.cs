    ...
    public class HomeController : BaseController
    {
        ...
        public ActionResult PrintTest(FormCollection form)
        {
            ...
            for (int i = 0; i < IDS.Length; i++)
            {
                ...
                if (i == 0)
                {
                    GenerateCode(sb, data, entity.TXZ01, entity.SPEC, entity.CHARG, entity.ORDER_MENGE.ToString(), entity.VFDAT == null ? "" : entity.VFDAT.ToString("yyyy-MM-dd"), "", entity.GYSNAME, entity.CODE, "", entity.MSEHT, entity.PKG_AMOUNT == null ? "" : entity.PKG_AMOUNT.ToString(), entity.PKG_NUMBER == null ? "" : entity.PKG_NUMBER.ToString(), entity.MENGE.ToString(), entity.FREEUSE1, entity.NAME,entity.FPHM);
                }
                else
                {
                    GenerateCode(sb, data, entity.TXZ01, entity.SPEC, entity.CHARG, entity.ORDER_MENGE.ToString(), entity.VFDAT == null ? "" : entity.VFDAT.ToString("yyyy-MM-dd"), "", entity.GYSNAME, entity.CODE, "page-break-before: always;", entity.MSEHT, entity.PKG_AMOUNT == null ? "" : entity.PKG_AMOUNT.ToString(), entity.PKG_NUMBER == null ? "" : entity.PKG_NUMBER.ToString(), entity.MENGE.ToString(), entity.FREEUSE1, entity.NAME, entity.FPHM);
                }
            }
        ...
        {
            var entity = BizLogicObject_V_SCM_D_SUPPLIERPLAN.Proxy.Get(new EntityObject_V_SCM_D_SUPPLIERPLAN { ID = id });
            var PKG_NUMBER = Convert.ToInt32(entity.PKG_NUMBER);
        ...
        /// <param name="ORDER_MENGE"></param>
        /// <param name="VFDAT"></param>
        /// <param name="perPage"></param>
        /// <param name="CREATENAME"></param>
        /// <param name="GYJH"></param>
        /// <param name="fenPage"></param>
        /// <param name="MSEHT"></param>
        /// <param name="PKG_AMOUNT"></param>
        /// <param name="PKG_NUMBER"></param>
        /// <param name="NUMBER"></param>
        /// <param name="WERKST">备注 后湖啥的</param>
        /// <param name="NAME"></param>
        /// <param name="FPHM"></param>
        public void GenerateCode(StringBuilder sb, string data, string TXZ01, string MATNR, string CHARG, string ORDER_MENGE, string VFDAT, string perPage, string CREATENAME, string GYJH, string fenPage, string MSEHT, string PKG_AMOUNT, string PKG_NUMBER, string NUMBER, string WERKST,string NAME,string FPHM)
        {
            ...
            sb.AppendFormat(replaceStr, TXZ01, MATNR, data, CHARG, ORDER_MENGE, VFDAT, FPHM, GYJH, CREATENAME, fenPage, MSEHT, PKG_AMOUNT, PKG_NUMBER, NUMBER, addTR,WERKST==null?"": WERKST.Replace("武汉协和医院","").Replace("-",""),NAME);
        }
            ...
            var reStr = "<div style=\"width: 340px; margin: 0; padding: 0; font-family:宋体;font-size: 14px; {9}\"><table cellpadding=\"0\" cellspacing=\"0\">{14}" +
                "<tr>" +
                    "<td colspan=\"2\" style=\"width: 240px;height:16px;font-family:宋体;font-size: 14px;\">" +
                        "华中科技大学同济医学院附属中心医院" +
                    "</td>" +
                    "<td  style=\"width: 100px;height:16px;font-family:宋体;font-weight:bold;font-size: 14px;\">" +
                        "{6}" +
                    "</td>" +
                "</tr>" +
                 "<tr>" +
        ...
        public string DownFile()
        {
            ...
            var dataSource = BizLogicObject_V_SCM_D_SUPPLIERPLAN.Proxy.Query(cause, null, OrderByPara).ToList();
