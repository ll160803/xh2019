...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function PrintPrintPage() {
            ...
            LODOP.ADD_PRINT_HTM(1, 1, $("#print").width(), $("#print").height()+20, document.getElementById("print").innerHTML);
            LODOP.SET_PRINT_PAGESIZE(1, 1020, 550, "");
            // LODOP.PREVIEW();
...
<body style="margin: 0; border: 0; padding: 0;">
    ...
    <div id="print" style="border: 0px; width: 340px; position: absolute; top: 0px; left: 10px;">
        <%:ViewBag.PrintStr %>
    </div>
