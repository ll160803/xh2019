                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" class="easyui-linkbutton" name="btnSave3" <%if(!string.IsNullOrEmpty(ViewBag.TName)){ %> style="display: none;"<%} %>;" id="btnSave3"
                            onclick="UpLoad(3,'BANK_NUMBER_Att','hide_BANK_NUMBER','btnSave3')">上传附件</a><span id="BANK_NUMBER_Att"><%:ViewBag.TName %><% if (ViewBag.Edit == "1"&&!string.IsNullOrEmpty(ViewBag.fouthName)){%><a
