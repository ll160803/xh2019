...
namespace Ipedf.Web.Entity
{
	[Serializable]
	[DataContract]
	[DataObject("BGT_B_DEPT_PLAN_MON_FACT")]
	public partial class CauseObject_BGT_B_DEPT_PLAN_MON_FACT:CauseBase
	{
	...
	[DataContract]
	[DataObject("BGT_B_DEPT_PLAN_MON_FACT")]
	public partial class DisplayObject_BGT_B_DEPT_PLAN_MON_FACT:EntityObject_BGT_B_DEPT_PLAN_MON_FACT
	{
		#region Attribute Block
	...
	[DataContract]
	[DataObject("BGT_B_DEPT_PLAN_MON_FACT")]
	public partial class EntityObject_BGT_B_DEPT_PLAN_MON_FACT:EntityBase
	{
		#region Attribute Block
