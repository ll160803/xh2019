...
namespace Ipedf.Web.Entity
{
	[Serializable]
	[DataContract]
	[DataObject("BGT_B_BUDGET_CONTROL")]
	public partial class CauseObject_BGT_B_BUDGET_CONTROL:CauseBase
	{
	...
	[DataContract]
	[DataObject("BGT_B_BUDGET_CONTROL")]
	public partial class DisplayObject_BGT_B_BUDGET_CONTROL:EntityObject_BGT_B_BUDGET_CONTROL
	{
		#region Attribute Block
	...
	[DataContract]
	[DataObject("BGT_B_BUDGET_CONTROL")]
	public partial class EntityObject_BGT_B_BUDGET_CONTROL:EntityBase
	{
		#region Attribute Block
