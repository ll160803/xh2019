...
namespace Ipedf.Web.Entity
{
	[Serializable]
	[DataContract]
	[DataObject("BGT_B_CPN_PLAN_MON")]
	public partial class CauseObject_BGT_B_CPN_PLAN_MON:CauseBase
	{
	...
	[DataContract]
	[DataObject("BGT_B_CPN_PLAN_MON")]
	public partial class DisplayObject_BGT_B_CPN_PLAN_MON:EntityObject_BGT_B_CPN_PLAN_MON
	{
		#region Attribute Block
	...
	[DataContract]
	[DataObject("BGT_B_CPN_PLAN_MON")]
	public partial class EntityObject_BGT_B_CPN_PLAN_MON:EntityBase
	{
		#region Attribute Block
