...
namespace Ipedf.Web.Entity
{
	[Serializable]
	[DataContract]
	[DataObject("BGT_B_CPN_HIS_DATA")]
	public partial class CauseObject_BGT_B_CPN_HIS_DATA:CauseBase
	{
	...
	[DataContract]
	[DataObject("BGT_B_CPN_HIS_DATA")]
	public partial class DisplayObject_BGT_B_CPN_HIS_DATA:EntityObject_BGT_B_CPN_HIS_DATA
	{
		#region Attribute Block
	...
	[DataContract]
	[DataObject("BGT_B_CPN_HIS_DATA")]
	public partial class EntityObject_BGT_B_CPN_HIS_DATA:EntityBase
	{
		#region Attribute Block
