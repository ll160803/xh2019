...
namespace Ipedf.Web.Entity
{
	[Serializable]
	[DataContract]
	[DataObject("BGT_B_DEPT_PLAN_YEAR_D_HIS")]
	public partial class CauseObject_BGT_B_DEPT_PLAN_YEAR_D_HIS:CauseBase
	{
	...
	[DataContract]
	[DataObject("BGT_B_DEPT_PLAN_YEAR_D_HIS")]
	public partial class DisplayObject_BGT_B_DEPT_PLAN_YEAR_D_HIS:EntityObject_BGT_B_DEPT_PLAN_YEAR_D_HIS
	{
		#region Attribute Block
	...
	[DataContract]
	[DataObject("BGT_B_DEPT_PLAN_YEAR_D_HIS")]
	public partial class EntityObject_BGT_B_DEPT_PLAN_YEAR_D_HIS:EntityBase
	{
		#region Attribute Block
