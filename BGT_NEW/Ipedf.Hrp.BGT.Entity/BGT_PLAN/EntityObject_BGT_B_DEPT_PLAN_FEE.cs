...
namespace Ipedf.Web.Entity
{
	[Serializable]
	[DataContract]
	[DataObject("BGT_B_DEPT_PLAN_FEE")]
	public partial class CauseObject_BGT_B_DEPT_PLAN_FEE:CauseBase
	{
	...
	[DataContract]
	[DataObject("BGT_B_DEPT_PLAN_FEE")]
	public partial class DisplayObject_BGT_B_DEPT_PLAN_FEE:EntityObject_BGT_B_DEPT_PLAN_FEE
	{
		#region Attribute Block
	...
	[DataContract]
	[DataObject("BGT_B_DEPT_PLAN_FEE")]
	public partial class EntityObject_BGT_B_DEPT_PLAN_FEE:EntityBase
	{
		#region Attribute Block
