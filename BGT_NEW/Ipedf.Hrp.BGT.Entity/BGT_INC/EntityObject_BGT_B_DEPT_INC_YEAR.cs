...
namespace Ipedf.Web.Entity
{
	[Serializable]
	[DataContract]
	[DataObject("BGT_B_DEPT_INC_YEAR")]
	public partial class CauseObject_BGT_B_DEPT_INC_YEAR:CauseBase
	{
	...
	[DataContract]
	[DataObject("BGT_B_DEPT_INC_YEAR")]
	public partial class DisplayObject_BGT_B_DEPT_INC_YEAR:EntityObject_BGT_B_DEPT_INC_YEAR
	{
		#region Attribute Block
	...
	[DataContract]
	[DataObject("BGT_B_DEPT_INC_YEAR")]
	public partial class EntityObject_BGT_B_DEPT_INC_YEAR:EntityBase
	{
		#region Attribute Block
