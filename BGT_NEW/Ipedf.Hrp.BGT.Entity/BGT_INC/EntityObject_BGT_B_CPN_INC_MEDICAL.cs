...
namespace Ipedf.Web.Entity
{
	[Serializable]
	[DataContract]
	[DataObject("BGT_B_CPN_INC_MEDICAL")]
	public partial class CauseObject_BGT_B_CPN_INC_MEDICAL:CauseBase
	{
	...
	[DataContract]
	[DataObject("BGT_B_CPN_INC_MEDICAL")]
	public partial class DisplayObject_BGT_B_CPN_INC_MEDICAL:EntityObject_BGT_B_CPN_INC_MEDICAL
	{
		#region Attribute Block
	...
	[DataContract]
	[DataObject("BGT_B_CPN_INC_MEDICAL")]
	public partial class EntityObject_BGT_B_CPN_INC_MEDICAL:EntityBase
	{
		#region Attribute Block
