...
namespace Ipedf.Web.Entity
{
	[Serializable]
	[DataContract]
	[DataObject("BGT_D_PLAN_ITEM")]
	public partial class CauseObject_BGT_D_PLAN_ITEM:CauseBase
	{
	...
	[DataContract]
	[DataObject("BGT_D_PLAN_ITEM")]
	public partial class DisplayObject_BGT_D_PLAN_ITEM:EntityObject_BGT_D_PLAN_ITEM
	{
		#region Attribute Block
	...
	[DataContract]
	[DataObject("BGT_D_PLAN_ITEM")]
	public partial class EntityObject_BGT_D_PLAN_ITEM:EntityBase
	{
		#region Attribute Block
