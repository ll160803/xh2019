...
namespace Ipedf.Web.Entity
{
	[Serializable]
	[DataContract]
	[DataObject("V_BGT_D_BUDGET_ITEM")]
	public partial class CauseObject_V_BGT_D_BUDGET_ITEM:CauseBase
	{
	...
	[DataContract]
	[DataObject("V_BGT_D_BUDGET_ITEM")]
	public partial class DisplayObject_V_BGT_D_BUDGET_ITEM:EntityObject_V_BGT_D_BUDGET_ITEM
	{
		#region Attribute Block
	...
	[DataContract]
	[DataObject("V_BGT_D_BUDGET_ITEM")]
	public partial class EntityObject_V_BGT_D_BUDGET_ITEM:EntityBase
	{
		#region Attribute Block
