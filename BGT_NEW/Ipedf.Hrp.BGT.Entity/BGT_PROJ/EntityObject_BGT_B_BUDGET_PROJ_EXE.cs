...
namespace Ipedf.Web.Entity
{
	[Serializable]
	[DataContract]
	[DataObject("BGT_B_BUDGET_PROJ_EXE")]
	public partial class CauseObject_BGT_B_BUDGET_PROJ_EXE:CauseBase
	{
	...
	[DataContract]
	[DataObject("BGT_B_BUDGET_PROJ_EXE")]
	public partial class DisplayObject_BGT_B_BUDGET_PROJ_EXE:EntityObject_BGT_B_BUDGET_PROJ_EXE
	{
		#region Attribute Block
	...
	[DataContract]
	[DataObject("BGT_B_BUDGET_PROJ_EXE")]
	public partial class EntityObject_BGT_B_BUDGET_PROJ_EXE:EntityBase
	{
		#region Attribute Block
