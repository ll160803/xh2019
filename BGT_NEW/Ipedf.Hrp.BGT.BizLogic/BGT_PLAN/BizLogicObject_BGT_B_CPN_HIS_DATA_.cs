...
{
    public partial class BizLogicObject_BGT_B_CPN_HIS_DATA
    {
        public List<string> CheckPlanService(EntityObject_BGT_B_CPN_HIS_DATA obj, DataTable data)
        {
            if (LocalMode)
            {
        ...
        public BizLogicMsg ImportPlanService(EntityObject_BGT_B_CPN_HIS_DATA obj, DataTable data)
        {
            if (LocalMode)
            {
        ...
        private List<string> CheckPlanImpl(EntityObject_BGT_B_CPN_HIS_DATA obj, DataTable data, IDbTransaction transaction)
        {
        ...
        private void ImportPlanImpl(EntityObject_BGT_B_CPN_HIS_DATA obj, DataTable data, IDbTransaction transaction)
        {
            for (int i = 0; i < data.Rows.Count; i++)
            {
                EntityObject_BGT_B_CPN_HIS_DATA_D cpnHisD = new EntityObject_BGT_B_CPN_HIS_DATA_D();
        ...
        public List<string> CheckIncomeService(EntityObject_BGT_B_CPN_HIS_DATA obj, DataTable data)
        {
            if (LocalMode)
            {
                List<string> colMsg = null;
        ...
        public BizLogicMsg ImportIncomeService(EntityObject_BGT_B_CPN_HIS_DATA obj, DataTable data)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
        ...
        private List<string> CheckIncomeImpl(EntityObject_BGT_B_CPN_HIS_DATA obj, DataTable data, IDbTransaction transaction)
        {
            List<string> colMsg = new List<string>();              //批量保存每行数据保存结果, 用于回写到数据源文件, 且列表第一条数据作为数据源是否有错误的标识
            colMsg.Add("Succeed");
            int errNum = 0;      //记录每行数据的错误数量
        ...
        private void ImportIncomeImpl(EntityObject_BGT_B_CPN_HIS_DATA obj, DataTable data, IDbTransaction transaction)
        {
            for (int i = 0; i < data.Rows.Count; i++)
            {
                EntityObject_BGT_B_CPN_HIS_DATA_D cpnHisD = new EntityObject_BGT_B_CPN_HIS_DATA_D();
        ...
        public List<string> CheckPayService(EntityObject_BGT_B_CPN_HIS_DATA obj, DataTable data)
        {
            if (LocalMode)
            {
                List<string> colMsg = null;
        ...
        public BizLogicMsg ImportPayService(EntityObject_BGT_B_CPN_HIS_DATA obj, DataTable data)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
        ...
        private List<string> CheckPayImpl(EntityObject_BGT_B_CPN_HIS_DATA obj, DataTable data, IDbTransaction transaction)
        {
            List<string> colMsg = new List<string>();              //批量保存每行数据保存结果, 用于回写到数据源文件, 且列表第一条数据作为数据源是否有错误的标识
            colMsg.Add("Succeed");
            int errNum = 0;      //记录每行数据的错误数量
        ...
        private void ImportPayImpl(EntityObject_BGT_B_CPN_HIS_DATA obj, DataTable data, IDbTransaction transaction)
        {
            for (int i = 0; i < data.Rows.Count; i++)
            {
                EntityObject_BGT_B_CPN_HIS_DATA_D cpnHisD = new EntityObject_BGT_B_CPN_HIS_DATA_D();
