...
{
	public partial class BizLogicObject_BGT_B_DEPT_PLAN_MON
	{
        public BizLogicMsg Calculate(EntityObject_BGT_B_DEPT_PLAN_MON obj)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
                string retMsg = string.Empty;
                int succeed = HelperObject_BGT_B_DEPT_PLAN_MON.Calculate(obj.BUDGET_YEAR,obj.BUDGET_DEPT_ID, out retMsg);
                msg.Message = retMsg;
        ...
        public List<string> CheckImportService(EntityObject_BGT_B_DEPT_PLAN_MON obj, DataTable data)
        {
            if (LocalMode)
            {
        ...
        public BizLogicMsg ImportDataService(EntityObject_BGT_B_DEPT_PLAN_MON obj, DataTable data)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
        ...
        private List<string> CheckImportImpl(EntityObject_BGT_B_DEPT_PLAN_MON obj, DataTable data, IDbTransaction transaction)
        {
        ...
        private void ImportDataImpl(EntityObject_BGT_B_DEPT_PLAN_MON obj, DataTable data, IDbTransaction transaction)
        {
            for (int i = 0; i < data.Rows.Count; i++)
            {
                EntityObject_BGT_B_DEPT_PLAN_MON_D deptMonD = new EntityObject_BGT_B_DEPT_PLAN_MON_D();
                ...
                HelperObject_BGT_B_DEPT_PLAN_MON_D.Save(deptMonD, transaction);
            }
        }
