...
namespace Ipedf.Web.BizLogic
{
	...
	{	
        ...
        public EntityObject_BGT_D_BUDGET_T_DEPT_I Load(string id , out EntityObject_BGT_D_BUDGET_DEPT budget_dept_id, out EntityObject_BGT_D_BUDGET_T base_id, out EntityObject_BGT_D_PLAN_ITEM item_id)
		{
			if (LocalMode)
			{
			...
			item_id = new EntityObject_BGT_D_PLAN_ITEM() ; 
				...
				using (IDbConnection connection = IDALProvider.IDAL.PopConnection())
				{
					using (IDbTransaction transaction = connection.BeginTransaction())
					{
						try
						{
							obj = Load(transaction,id , out  budget_dept_id, out  base_id, out  item_id);                
							transaction.Commit();
						}
						catch (Exception expt)
						{
			...
			else
			{
				using (ServiceManager<ServiceContract_BGT_D_BUDGET_T_DEPT_I> smgr = new ServiceManager<ServiceContract_BGT_D_BUDGET_T_DEPT_I>(ServiceUri))
                {
                    return smgr.Service.Load(id , out budget_dept_id, out base_id, out item_id);
                }
			}
		}
		public EntityObject_BGT_D_BUDGET_T_DEPT_I Load(IDbTransaction transaction,string id , out EntityObject_BGT_D_BUDGET_DEPT budget_dept_id, out EntityObject_BGT_D_BUDGET_T base_id, out EntityObject_BGT_D_PLAN_ITEM item_id)
		{
			if (LocalMode)
			{
				EntityObject_BGT_D_BUDGET_T_DEPT_I obj = new EntityObject_BGT_D_BUDGET_T_DEPT_I();
		...
		public void CommitUpdate(EntityObject_BGT_D_BUDGET_T_DEPT_I[] saveEntities, EntityObject_BGT_D_BUDGET_T_DEPT_I[] updateEntities, EntityObject_BGT_D_BUDGET_T_DEPT_I[] deleteEntities)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
		...
		#if NESTING
		public void CommitSave(EntityObject_BGT_D_BUDGET_T_DEPT_I saveBaseEntity, EntityObject_[] saveDetailEntities)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
        ...
        public void CommitDelete(EntityObject_BGT_D_BUDGET_T_DEPT_I deleteBaseEntity)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
        ...
        public void CommitUpdate(EntityObject_BGT_D_BUDGET_T_DEPT_I updateBaseEntity, EntityObject_[] saveDetailEntities, EntityObject_[] updateDetailEntities, EntityObject_[] deleteDetailEntities)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
