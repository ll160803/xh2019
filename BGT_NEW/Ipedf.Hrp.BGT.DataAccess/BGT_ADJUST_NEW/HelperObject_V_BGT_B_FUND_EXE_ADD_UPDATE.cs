...
namespace Ipedf.Web.DataAccess
{
	...
	{		
		...
		public static int Update(EntityObject_V_BGT_B_FUND_EXE_ADD_UPDATE obj,IDbTransaction trans)
		{
			...
			#endregion
			string sSql = "update V_BGT_B_FUND_EXE_ADD_UPDATE set ";
			sSql += PrepareUpdate(obj, out parameters);
			sSql += " where  (1=1) ";
			return IDALProvider.IDAL.ExecuteNonQuery(sSql,parameters,trans);
		}
		public static int Delete(EntityObject_V_BGT_B_FUND_EXE_ADD_UPDATE obj,IDbTransaction trans)
		{
			
			//平台自动生成代码
			string sSql = "delete from V_BGT_B_FUND_EXE_ADD_UPDATE where  (1=1) ";
			#region Parameters Block
			OracleParameter[] parameters = new OracleParameter[0];
			#endregion 
			return IDALProvider.IDAL.ExecuteNonQuery(sSql,parameters,trans);
		}
		public static EntityObject_V_BGT_B_FUND_EXE_ADD_UPDATE Get(EntityObject_V_BGT_B_FUND_EXE_ADD_UPDATE obj)
		{
			
			//平台自动生成代码
			string sSql = "select  ITEM_NAME, FUND_MONEY, FUND_TYPE_ID_NAME, BUDGET_YEAR_NAME, IS_ATTACH, BGT_D_BUDGET_ITEM_ID, STATE_NAME, ID, BUDGET_DEPT_ID_NAME, STATE, MODIFY_DEPT_ID, IS_PERFORMANCE, DATA_ORGANISE_ID, MODIFY_TIME, CODE, DEPT_USER_ID, IS_FIXED, CREATE_USER_ID, BUDGET_DEPT_ID, CREATE_DEPT_ID, IS_FIXED_NAME, FREE_FIELD3, FREE_FIELD2, FUND_TYPE_ID, CREATE_TIME, DEPT_USER_ID_NAME, NAME, BUDGET_YEAR, MODIFY_USER_ID, FINANCE_IDEA, DECALRE_CAUSE, COMMENTS, BGT_D_BUDGET_ITEM_ID_NAME, CONTROL_MONEY, IS_PERFORMANCE_NAME, FREE_FIELD from V_BGT_B_FUND_EXE_ADD_UPDATE where  (1=1) ";
			#region Parameters Block
			OracleParameter[] parameters = new OracleParameter[0];
			#endregion 
			#region Push Block
			EntityObject_V_BGT_B_FUND_EXE_ADD_UPDATE dataObj = null;
			ArrayList objArray = new ArrayList();
			IDbConnection connection = IDALProvider.IDAL.PopConnection();
			IDataReader sqlReader = IDALProvider.IDAL.ExecuteReader(sSql,parameters,connection);
			while (sqlReader.Read())
			{
				dataObj = new EntityObject_V_BGT_B_FUND_EXE_ADD_UPDATE();
			...
			#endregion 
			EntityObject_V_BGT_B_FUND_EXE_ADD_UPDATE[] objs = new EntityObject_V_BGT_B_FUND_EXE_ADD_UPDATE[objArray.Count];
			objArray.CopyTo(0,objs,0,objs.Length);
			return objs.Length == 0 ? null:objs[0];
		}
		public static EntityObject_V_BGT_B_FUND_EXE_ADD_UPDATE Get(EntityObject_V_BGT_B_FUND_EXE_ADD_UPDATE obj,IDbTransaction trans)
		{
		...
		public static DisplayObject_V_BGT_B_FUND_EXE_ADD_UPDATE[] List()
		{
			
			//平台自动生成代码
			string sSql = " select  V_BGT_B_FUND_EXE_ADD_UPDATE.ITEM_NAME, V_BGT_B_FUND_EXE_ADD_UPDATE.FUND_MONEY, V_BGT_B_FUND_EXE_ADD_UPDATE.FUND_TYPE_ID_NAME, V_BGT_B_FUND_EXE_ADD_UPDATE.BUDGET_YEAR_NAME, V_BGT_B_FUND_EXE_ADD_UPDATE.IS_ATTACH, V_BGT_B_FUND_EXE_ADD_UPDATE.BGT_D_BUDGET_ITEM_ID, V_BGT_B_FUND_EXE_ADD_UPDATE.STATE_NAME, V_BGT_B_FUND_EXE_ADD_UPDATE.ID, V_BGT_B_FUND_EXE_ADD_UPDATE.BUDGET_DEPT_ID_NAME, V_BGT_B_FUND_EXE_ADD_UPDATE.STATE, V_BGT_B_FUND_EXE_ADD_UPDATE.MODIFY_DEPT_ID, V_BGT_B_FUND_EXE_ADD_UPDATE.IS_PERFORMANCE, V_BGT_B_FUND_EXE_ADD_UPDATE.DATA_ORGANISE_ID, V_BGT_B_FUND_EXE_ADD_UPDATE.MODIFY_TIME, V_BGT_B_FUND_EXE_ADD_UPDATE.CODE, V_BGT_B_FUND_EXE_ADD_UPDATE.DEPT_USER_ID, V_BGT_B_FUND_EXE_ADD_UPDATE.IS_FIXED, V_BGT_B_FUND_EXE_ADD_UPDATE.CREATE_USER_ID, V_BGT_B_FUND_EXE_ADD_UPDATE.BUDGET_DEPT_ID, V_BGT_B_FUND_EXE_ADD_UPDATE.CREATE_DEPT_ID, V_BGT_B_FUND_EXE_ADD_UPDATE.IS_FIXED_NAME, V_BGT_B_FUND_EXE_ADD_UPDATE.FREE_FIELD3, V_BGT_B_FUND_EXE_ADD_UPDATE.FREE_FIELD2, V_BGT_B_FUND_EXE_ADD_UPDATE.FUND_TYPE_ID, V_BGT_B_FUND_EXE_ADD_UPDATE.CREATE_TIME, V_BGT_B_FUND_EXE_ADD_UPDATE.DEPT_USER_ID_NAME, V_BGT_B_FUND_EXE_ADD_UPDATE.NAME, V_BGT_B_FUND_EXE_ADD_UPDATE.BUDGET_YEAR, V_BGT_B_FUND_EXE_ADD_UPDATE.MODIFY_USER_ID, V_BGT_B_FUND_EXE_ADD_UPDATE.FINANCE_IDEA, V_BGT_B_FUND_EXE_ADD_UPDATE.DECALRE_CAUSE, V_BGT_B_FUND_EXE_ADD_UPDATE.COMMENTS, V_BGT_B_FUND_EXE_ADD_UPDATE.BGT_D_BUDGET_ITEM_ID_NAME, V_BGT_B_FUND_EXE_ADD_UPDATE.CONTROL_MONEY, V_BGT_B_FUND_EXE_ADD_UPDATE.IS_PERFORMANCE_NAME, V_BGT_B_FUND_EXE_ADD_UPDATE.FREE_FIELD from V_BGT_B_FUND_EXE_ADD_UPDATE where (1=1)";
			#region Parameters Block
			OracleParameter[] parameters = new OracleParameter[0];
			#endregion 
			#region Push Block
			DisplayObject_V_BGT_B_FUND_EXE_ADD_UPDATE dataObj = null;
			ArrayList objArray = new ArrayList();
			IDbConnection connection = IDALProvider.IDAL.PopConnection();
			IDataReader sqlReader = IDALProvider.IDAL.ExecuteReader(sSql,parameters,connection);
			while (sqlReader.Read())
			{
				dataObj = new DisplayObject_V_BGT_B_FUND_EXE_ADD_UPDATE();
				if(!sqlReader.IsDBNull(0)) 
					dataObj.ITEM_NAME = sqlReader.GetString(0);
				if(!sqlReader.IsDBNull(1)) 
					dataObj.FUND_MONEY = sqlReader.GetDecimal(1);
			...
			IDALProvider.IDAL.PushConnection(connection);
			#endregion 
			DisplayObject_V_BGT_B_FUND_EXE_ADD_UPDATE[] objs = new DisplayObject_V_BGT_B_FUND_EXE_ADD_UPDATE[objArray.Count];
			objArray.CopyTo(0,objs,0,objs.Length);
			return objs;
		}
		public static string PrepareCause(CauseObject_V_BGT_B_FUND_EXE_ADD_UPDATE cause,out OracleParameter[] parameters )
		{
			...
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.ITEM_NAME ").Append((cause.ITEM_NAME.StartsWith("%") || cause.ITEM_NAME.EndsWith("%")) ? " like " : " = ").Append(" :ITEM_NAME");
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "ITEM_NAME"));
			}
			if(cause.FUND_MONEY!= ConstLibrary.Template.UndefineDecimal)
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.FUND_MONEY = :FUND_MONEY");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "FUND_MONEY"));
			}
			if(!string.IsNullOrEmpty(cause.FUND_TYPE_ID_NAME))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.FUND_TYPE_ID_NAME ").Append((cause.FUND_TYPE_ID_NAME.StartsWith("%") || cause.FUND_TYPE_ID_NAME.EndsWith("%")) ? " like " : " = ").Append(" :FUND_TYPE_ID_NAME");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "FUND_TYPE_ID_NAME"));
			}
			if(!string.IsNullOrEmpty(cause.BUDGET_YEAR_NAME))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.BUDGET_YEAR_NAME ").Append((cause.BUDGET_YEAR_NAME.StartsWith("%") || cause.BUDGET_YEAR_NAME.EndsWith("%")) ? " like " : " = ").Append(" :BUDGET_YEAR_NAME");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "BUDGET_YEAR_NAME"));
			}
			if(!string.IsNullOrEmpty(cause.IS_ATTACH))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.IS_ATTACH ").Append((cause.IS_ATTACH.StartsWith("%") || cause.IS_ATTACH.EndsWith("%")) ? " like " : " = ").Append(" :IS_ATTACH");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "IS_ATTACH"));
			}
			if(!string.IsNullOrEmpty(cause.BGT_D_BUDGET_ITEM_ID))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.BGT_D_BUDGET_ITEM_ID ").Append((cause.BGT_D_BUDGET_ITEM_ID.StartsWith("%") || cause.BGT_D_BUDGET_ITEM_ID.EndsWith("%")) ? " like " : " = ").Append(" :BGT_D_BUDGET_ITEM_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "BGT_D_BUDGET_ITEM_ID"));
			}
			if(!string.IsNullOrEmpty(cause.STATE_NAME))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.STATE_NAME ").Append((cause.STATE_NAME.StartsWith("%") || cause.STATE_NAME.EndsWith("%")) ? " like " : " = ").Append(" :STATE_NAME");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "STATE_NAME"));
			}
			if(!string.IsNullOrEmpty(cause.ID))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.ID ").Append((cause.ID.StartsWith("%") || cause.ID.EndsWith("%")) ? " like " : " = ").Append(" :ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "ID"));
			}
			if(!string.IsNullOrEmpty(cause.BUDGET_DEPT_ID_NAME))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.BUDGET_DEPT_ID_NAME ").Append((cause.BUDGET_DEPT_ID_NAME.StartsWith("%") || cause.BUDGET_DEPT_ID_NAME.EndsWith("%")) ? " like " : " = ").Append(" :BUDGET_DEPT_ID_NAME");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "BUDGET_DEPT_ID_NAME"));
			}
			if(cause.STATE!= ConstLibrary.Template.UndefineDecimal)
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.STATE = :STATE");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "STATE"));
			}
			if(!string.IsNullOrEmpty(cause.MODIFY_DEPT_ID))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.MODIFY_DEPT_ID ").Append((cause.MODIFY_DEPT_ID.StartsWith("%") || cause.MODIFY_DEPT_ID.EndsWith("%")) ? " like " : " = ").Append(" :MODIFY_DEPT_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "MODIFY_DEPT_ID"));
			}
			if(cause.IS_PERFORMANCE!= ConstLibrary.Template.UndefineDecimal)
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.IS_PERFORMANCE = :IS_PERFORMANCE");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "IS_PERFORMANCE"));
			}
			if(!string.IsNullOrEmpty(cause.DATA_ORGANISE_ID))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.DATA_ORGANISE_ID ").Append((cause.DATA_ORGANISE_ID.StartsWith("%") || cause.DATA_ORGANISE_ID.EndsWith("%")) ? " like " : " = ").Append(" :DATA_ORGANISE_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "DATA_ORGANISE_ID"));
			}
			if(cause.MODIFY_TIME!= null)
			{
				if (cause.MODIFY_TIME.Begin != null)
				{
					strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.MODIFY_TIME >= :MODIFY_TIME_BEGIN");
					param = new OracleParameter();
				...
				{
					strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.MODIFY_TIME < :MODIFY_TIME_END");
					param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "MODIFY_TIME"));
			}
			if(!string.IsNullOrEmpty(cause.CODE))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.CODE ").Append((cause.CODE.StartsWith("%") || cause.CODE.EndsWith("%")) ? " like " : " = ").Append(" :CODE");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "CODE"));
			}
			if(!string.IsNullOrEmpty(cause.DEPT_USER_ID))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.DEPT_USER_ID ").Append((cause.DEPT_USER_ID.StartsWith("%") || cause.DEPT_USER_ID.EndsWith("%")) ? " like " : " = ").Append(" :DEPT_USER_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "DEPT_USER_ID"));
			}
			if(cause.IS_FIXED!= ConstLibrary.Template.UndefineDecimal)
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.IS_FIXED = :IS_FIXED");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "IS_FIXED"));
			}
			if(!string.IsNullOrEmpty(cause.CREATE_USER_ID))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.CREATE_USER_ID ").Append((cause.CREATE_USER_ID.StartsWith("%") || cause.CREATE_USER_ID.EndsWith("%")) ? " like " : " = ").Append(" :CREATE_USER_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "CREATE_USER_ID"));
			}
			if(!string.IsNullOrEmpty(cause.BUDGET_DEPT_ID))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.BUDGET_DEPT_ID ").Append((cause.BUDGET_DEPT_ID.StartsWith("%") || cause.BUDGET_DEPT_ID.EndsWith("%")) ? " like " : " = ").Append(" :BUDGET_DEPT_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "BUDGET_DEPT_ID"));
			}
			if(!string.IsNullOrEmpty(cause.CREATE_DEPT_ID))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.CREATE_DEPT_ID ").Append((cause.CREATE_DEPT_ID.StartsWith("%") || cause.CREATE_DEPT_ID.EndsWith("%")) ? " like " : " = ").Append(" :CREATE_DEPT_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "CREATE_DEPT_ID"));
			}
			if(!string.IsNullOrEmpty(cause.IS_FIXED_NAME))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.IS_FIXED_NAME ").Append((cause.IS_FIXED_NAME.StartsWith("%") || cause.IS_FIXED_NAME.EndsWith("%")) ? " like " : " = ").Append(" :IS_FIXED_NAME");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "IS_FIXED_NAME"));
			}
			if(!string.IsNullOrEmpty(cause.FREE_FIELD3))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.FREE_FIELD3 ").Append((cause.FREE_FIELD3.StartsWith("%") || cause.FREE_FIELD3.EndsWith("%")) ? " like " : " = ").Append(" :FREE_FIELD3");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "FREE_FIELD3"));
			}
			if(!string.IsNullOrEmpty(cause.FREE_FIELD2))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.FREE_FIELD2 ").Append((cause.FREE_FIELD2.StartsWith("%") || cause.FREE_FIELD2.EndsWith("%")) ? " like " : " = ").Append(" :FREE_FIELD2");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "FREE_FIELD2"));
			}
			if(!string.IsNullOrEmpty(cause.FUND_TYPE_ID))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.FUND_TYPE_ID ").Append((cause.FUND_TYPE_ID.StartsWith("%") || cause.FUND_TYPE_ID.EndsWith("%")) ? " like " : " = ").Append(" :FUND_TYPE_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "FUND_TYPE_ID"));
			}
			if(cause.CREATE_TIME!= null)
			{
				if (cause.CREATE_TIME.Begin != null)
				{
					strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.CREATE_TIME >= :CREATE_TIME_BEGIN");
					param = new OracleParameter();
				...
				{
					strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.CREATE_TIME < :CREATE_TIME_END");
					param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "CREATE_TIME"));
			}
			if(!string.IsNullOrEmpty(cause.DEPT_USER_ID_NAME))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.DEPT_USER_ID_NAME ").Append((cause.DEPT_USER_ID_NAME.StartsWith("%") || cause.DEPT_USER_ID_NAME.EndsWith("%")) ? " like " : " = ").Append(" :DEPT_USER_ID_NAME");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "DEPT_USER_ID_NAME"));
			}
			if(!string.IsNullOrEmpty(cause.NAME))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.NAME ").Append((cause.NAME.StartsWith("%") || cause.NAME.EndsWith("%")) ? " like " : " = ").Append(" :NAME");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "NAME"));
			}
			if(!string.IsNullOrEmpty(cause.BUDGET_YEAR))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.BUDGET_YEAR ").Append((cause.BUDGET_YEAR.StartsWith("%") || cause.BUDGET_YEAR.EndsWith("%")) ? " like " : " = ").Append(" :BUDGET_YEAR");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "BUDGET_YEAR"));
			}
			if(!string.IsNullOrEmpty(cause.MODIFY_USER_ID))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.MODIFY_USER_ID ").Append((cause.MODIFY_USER_ID.StartsWith("%") || cause.MODIFY_USER_ID.EndsWith("%")) ? " like " : " = ").Append(" :MODIFY_USER_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "MODIFY_USER_ID"));
			}
			if(!string.IsNullOrEmpty(cause.FINANCE_IDEA))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.FINANCE_IDEA ").Append((cause.FINANCE_IDEA.StartsWith("%") || cause.FINANCE_IDEA.EndsWith("%")) ? " like " : " = ").Append(" :FINANCE_IDEA");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "FINANCE_IDEA"));
			}
			if(!string.IsNullOrEmpty(cause.DECALRE_CAUSE))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.DECALRE_CAUSE ").Append((cause.DECALRE_CAUSE.StartsWith("%") || cause.DECALRE_CAUSE.EndsWith("%")) ? " like " : " = ").Append(" :DECALRE_CAUSE");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "DECALRE_CAUSE"));
			}
			if(!string.IsNullOrEmpty(cause.COMMENTS))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.COMMENTS ").Append((cause.COMMENTS.StartsWith("%") || cause.COMMENTS.EndsWith("%")) ? " like " : " = ").Append(" :COMMENTS");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "COMMENTS"));
			}
			if(!string.IsNullOrEmpty(cause.BGT_D_BUDGET_ITEM_ID_NAME))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.BGT_D_BUDGET_ITEM_ID_NAME ").Append((cause.BGT_D_BUDGET_ITEM_ID_NAME.StartsWith("%") || cause.BGT_D_BUDGET_ITEM_ID_NAME.EndsWith("%")) ? " like " : " = ").Append(" :BGT_D_BUDGET_ITEM_ID_NAME");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "BGT_D_BUDGET_ITEM_ID_NAME"));
			}
			if(cause.CONTROL_MONEY!= ConstLibrary.Template.UndefineDecimal)
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.CONTROL_MONEY = :CONTROL_MONEY");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "CONTROL_MONEY"));
			}
			if(!string.IsNullOrEmpty(cause.IS_PERFORMANCE_NAME))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.IS_PERFORMANCE_NAME ").Append((cause.IS_PERFORMANCE_NAME.StartsWith("%") || cause.IS_PERFORMANCE_NAME.EndsWith("%")) ? " like " : " = ").Append(" :IS_PERFORMANCE_NAME");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "IS_PERFORMANCE_NAME"));
			}
			if(!string.IsNullOrEmpty(cause.FREE_FIELD))
			{
				strBuf.Append(" And V_BGT_B_FUND_EXE_ADD_UPDATE.FREE_FIELD ").Append((cause.FREE_FIELD.StartsWith("%") || cause.FREE_FIELD.EndsWith("%")) ? " like " : " = ").Append(" :FREE_FIELD");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("V_BGT_B_FUND_EXE_ADD_UPDATE", "FREE_FIELD"));
			}
		...
		public static DisplayObject_V_BGT_B_FUND_EXE_ADD_UPDATE[] Query(CauseObject_V_BGT_B_FUND_EXE_ADD_UPDATE cause)
		{
		...
		public static int Delete(CauseObject_V_BGT_B_FUND_EXE_ADD_UPDATE cause,IDbTransaction trans)
		{
		...
		public static DisplayObject_V_BGT_B_FUND_EXE_ADD_UPDATE[] Query(CauseObject_V_BGT_B_FUND_EXE_ADD_UPDATE cause,IDbTransaction trans)
		{
		...
		public static DisplayObject_V_BGT_B_FUND_EXE_ADD_UPDATE[] Query(CauseObject_V_BGT_B_FUND_EXE_ADD_UPDATE cause,PagingParamter paging,OrderByParameter order)
		{
			...
			if (paging != null)
			{
				...
				sqlReader = IDALProvider.IDAL.ExecutePagingReader("V_BGT_B_FUND_EXE_ADD_UPDATE",paging, order, sSql, parameters, connection);
			}
			else if (order != null)
			{
				sSql += order.ToString();
		...
		public static DisplayObject_V_BGT_B_FUND_EXE_ADD_UPDATE[] Query(CauseObject_V_BGT_B_FUND_EXE_ADD_UPDATE cause,PagingParamter paging,OrderByParameter order,IDbTransaction trans)
		{
			...
			if (paging != null)
			{
				...
				sqlReader = IDALProvider.IDAL.ExecutePagingReader("V_BGT_B_FUND_EXE_ADD_UPDATE",paging, order, sSql, parameters, trans);
			}
			else if (order != null)
			{
				sSql += order.ToString();
		...
		public static string PrepareUpdate(EntityObject_V_BGT_B_FUND_EXE_ADD_UPDATE obj, out OracleParameter[] parameters )
        {
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.ITEM_NAME = :ITEM_NAME");
				param = new OracleParameter();
				param.ParameterName = ":ITEM_NAME";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 200;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.FUND_MONEY = :FUND_MONEY");
				param = new OracleParameter();
				param.ParameterName = ":FUND_MONEY";
				param.OracleType = System.Data.OracleClient.OracleType.Number;
				param.Size = 22;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.FUND_TYPE_ID_NAME = :FUND_TYPE_ID_NAME");
				param = new OracleParameter();
				param.ParameterName = ":FUND_TYPE_ID_NAME";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 50;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.BUDGET_YEAR_NAME = :BUDGET_YEAR_NAME");
				param = new OracleParameter();
				param.ParameterName = ":BUDGET_YEAR_NAME";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 50;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.IS_ATTACH = :IS_ATTACH");
				param = new OracleParameter();
				param.ParameterName = ":IS_ATTACH";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 2;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.BGT_D_BUDGET_ITEM_ID = :BGT_D_BUDGET_ITEM_ID");
				param = new OracleParameter();
				param.ParameterName = ":BGT_D_BUDGET_ITEM_ID";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.STATE_NAME = :STATE_NAME");
				param = new OracleParameter();
				param.ParameterName = ":STATE_NAME";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 6;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.ID = :ID");
				param = new OracleParameter();
				param.ParameterName = ":ID";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.BUDGET_DEPT_ID_NAME = :BUDGET_DEPT_ID_NAME");
				param = new OracleParameter();
				param.ParameterName = ":BUDGET_DEPT_ID_NAME";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 50;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.STATE = :STATE");
				param = new OracleParameter();
				param.ParameterName = ":STATE";
				param.OracleType = System.Data.OracleClient.OracleType.Number;
				param.Size = 22;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.MODIFY_DEPT_ID = :MODIFY_DEPT_ID");
				param = new OracleParameter();
				param.ParameterName = ":MODIFY_DEPT_ID";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.IS_PERFORMANCE = :IS_PERFORMANCE");
				param = new OracleParameter();
				param.ParameterName = ":IS_PERFORMANCE";
				param.OracleType = System.Data.OracleClient.OracleType.Number;
				param.Size = 22;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.DATA_ORGANISE_ID = :DATA_ORGANISE_ID");
				param = new OracleParameter();
				param.ParameterName = ":DATA_ORGANISE_ID";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.MODIFY_TIME = :MODIFY_TIME");
				param = new OracleParameter();
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.CODE = :CODE");
				param = new OracleParameter();
				param.ParameterName = ":CODE";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 50;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.DEPT_USER_ID = :DEPT_USER_ID");
				param = new OracleParameter();
				param.ParameterName = ":DEPT_USER_ID";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.IS_FIXED = :IS_FIXED");
				param = new OracleParameter();
				param.ParameterName = ":IS_FIXED";
				param.OracleType = System.Data.OracleClient.OracleType.Number;
				param.Size = 22;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.BUDGET_DEPT_ID = :BUDGET_DEPT_ID");
				param = new OracleParameter();
				param.ParameterName = ":BUDGET_DEPT_ID";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.CREATE_DEPT_ID = :CREATE_DEPT_ID");
				param = new OracleParameter();
				param.ParameterName = ":CREATE_DEPT_ID";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.IS_FIXED_NAME = :IS_FIXED_NAME");
				param = new OracleParameter();
				param.ParameterName = ":IS_FIXED_NAME";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 2;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.FREE_FIELD3 = :FREE_FIELD3");
				param = new OracleParameter();
				param.ParameterName = ":FREE_FIELD3";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 10;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.FREE_FIELD2 = :FREE_FIELD2");
				param = new OracleParameter();
				param.ParameterName = ":FREE_FIELD2";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 200;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.FUND_TYPE_ID = :FUND_TYPE_ID");
				param = new OracleParameter();
				param.ParameterName = ":FUND_TYPE_ID";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.DEPT_USER_ID_NAME = :DEPT_USER_ID_NAME");
				param = new OracleParameter();
				param.ParameterName = ":DEPT_USER_ID_NAME";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 50;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.NAME = :NAME");
				param = new OracleParameter();
				param.ParameterName = ":NAME";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 100;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.BUDGET_YEAR = :BUDGET_YEAR");
				param = new OracleParameter();
				param.ParameterName = ":BUDGET_YEAR";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.MODIFY_USER_ID = :MODIFY_USER_ID");
				param = new OracleParameter();
				param.ParameterName = ":MODIFY_USER_ID";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.FINANCE_IDEA = :FINANCE_IDEA");
				param = new OracleParameter();
				param.ParameterName = ":FINANCE_IDEA";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 500;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.DECALRE_CAUSE = :DECALRE_CAUSE");
				param = new OracleParameter();
				param.ParameterName = ":DECALRE_CAUSE";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 2000;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.COMMENTS = :COMMENTS");
				param = new OracleParameter();
				param.ParameterName = ":COMMENTS";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 200;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.BGT_D_BUDGET_ITEM_ID_NAME = :BGT_D_BUDGET_ITEM_ID_NAME");
				param = new OracleParameter();
				param.ParameterName = ":BGT_D_BUDGET_ITEM_ID_NAME";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 100;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.CONTROL_MONEY = :CONTROL_MONEY");
				param = new OracleParameter();
				param.ParameterName = ":CONTROL_MONEY";
				param.OracleType = System.Data.OracleClient.OracleType.Number;
				param.Size = 22;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.IS_PERFORMANCE_NAME = :IS_PERFORMANCE_NAME");
				param = new OracleParameter();
				param.ParameterName = ":IS_PERFORMANCE_NAME";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 2;
			...
			{
				strBuf.Add("  V_BGT_B_FUND_EXE_ADD_UPDATE.FREE_FIELD = :FREE_FIELD");
				param = new OracleParameter();
				param.ParameterName = ":FREE_FIELD";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 50;
