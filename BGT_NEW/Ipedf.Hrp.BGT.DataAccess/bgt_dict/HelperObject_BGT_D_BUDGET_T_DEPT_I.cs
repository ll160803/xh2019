...
namespace Ipedf.Web.DataAccess
{
	...
	{		
		...
		public static int Save(EntityObject_BGT_D_BUDGET_T_DEPT_I obj,IDbTransaction trans)
		{
			...
			string sSql = "insert into BGT_D_BUDGET_T_DEPT_I( DATA_ORGANISE_ID, BUDGET_DEPT_ID, ID, CREATE_DEPT_ID, BASE_ID, STATE, BUDGET_YEAR, MODIFY_DEPT_ID, CREATE_TIME, BUDGET_CONTENTS_ID, CREATE_USER_ID, COMMENTS) values ( :DATA_ORGANISE_ID, :BUDGET_DEPT_ID, :ID, :CREATE_DEPT_ID, :BASE_ID, :STATE, :BUDGET_YEAR, :MODIFY_DEPT_ID, :CREATE_TIME, :BUDGET_CONTENTS_ID, :CREATE_USER_ID, :COMMENTS)";
			...
			parameters[3].ParameterName =":CREATE_DEPT_ID";
			parameters[3].Size = 36;
			parameters[3].OracleType = System.Data.OracleClient.OracleType.Char;
			parameters[3].Value = obj.CREATE_DEPT_ID == null ? String.Empty:obj.CREATE_DEPT_ID;
		...
		public static EntityObject_BGT_D_BUDGET_T_DEPT_I Get(EntityObject_BGT_D_BUDGET_T_DEPT_I obj)
		{
			...
			//平台自动生成代码
			string sSql = "select  DATA_ORGANISE_ID, BUDGET_DEPT_ID, ID, CREATE_DEPT_ID, MODIFY_TIME, BASE_ID, STATE, BUDGET_YEAR, MODIFY_DEPT_ID, CREATE_TIME, MODIFY_USER_ID, BUDGET_CONTENTS_ID, CREATE_USER_ID, COMMENTS from BGT_D_BUDGET_T_DEPT_I where  ID = :ID ";
			#region Parameters Block
			OracleParameter[] parameters = new OracleParameter[1];
			parameters[0] = new OracleParameter();
			parameters[0].ParameterName =":ID";
			...
			while (sqlReader.Read())
			{
				...
				if(!sqlReader.IsDBNull(3)) 
					dataObj.CREATE_DEPT_ID = sqlReader.GetString(3);
				...
				if(!sqlReader.IsDBNull(12)) 
					dataObj.CREATE_USER_ID = sqlReader.GetString(12);
		...
		public static DisplayObject_BGT_D_BUDGET_T_DEPT_I[] List()
		{
			...
			//平台自动生成代码
			string sSql = " select  BGT_D_BUDGET_T_DEPT_I.DATA_ORGANISE_ID, BGT_D_BUDGET_T_DEPT_I.BUDGET_DEPT_ID, BGT_D_BUDGET_T_DEPT_I.ID, BGT_D_BUDGET_T_DEPT_I.CREATE_DEPT_ID, BGT_D_BUDGET_T_DEPT_I.MODIFY_TIME, BGT_D_BUDGET_T_DEPT_I.BASE_ID, BGT_D_BUDGET_T_DEPT_I.STATE, BGT_D_BUDGET_T_DEPT_I.BUDGET_YEAR, BGT_D_BUDGET_T_DEPT_I.MODIFY_DEPT_ID, BGT_D_BUDGET_T_DEPT_I.CREATE_TIME, BGT_D_BUDGET_T_DEPT_I.MODIFY_USER_ID, BGT_D_BUDGET_T_DEPT_I.BUDGET_CONTENTS_ID, BGT_D_BUDGET_T_DEPT_I.CREATE_USER_ID, BGT_D_BUDGET_T_DEPT_I.COMMENTS, BGT_D_BUDGET_DEPT_BUDGET_DEPT_.NAME as BUDGET_DEPT_ID_NAME, (case  when BGT_D_BUDGET_T_DEPT_I.STATE = 0 then '默认值' when BGT_D_BUDGET_T_DEPT_I.STATE = 1 then '编辑中' when BGT_D_BUDGET_T_DEPT_I.STATE = 2 then '已提交' when BGT_D_BUDGET_T_DEPT_I.STATE = 3 then '已审核' when BGT_D_BUDGET_T_DEPT_I.STATE = 4 then '已归档' when BGT_D_BUDGET_T_DEPT_I.STATE = 9 then '已作废' else '' end ) as STATE_NAME, BGT_D_BUDGET_YEAR_BUDGET_YEAR.BUDGET_YEAR as BUDGET_YEAR_NAME from BGT_D_BUDGET_T_DEPT_I left join BGT_D_BUDGET_DEPT   BGT_D_BUDGET_DEPT_BUDGET_DEPT_ on BGT_D_BUDGET_T_DEPT_I.BUDGET_DEPT_ID = BGT_D_BUDGET_DEPT_BUDGET_DEPT_.ID left join BGT_D_BUDGET_YEAR   BGT_D_BUDGET_YEAR_BUDGET_YEAR on BGT_D_BUDGET_T_DEPT_I.BUDGET_YEAR = BGT_D_BUDGET_YEAR_BUDGET_YEAR.ID where (1=1)";
			#region Parameters Block
		...
		public static string PrepareCause(CauseObject_BGT_D_BUDGET_T_DEPT_I cause,out OracleParameter[] parameters )
		{
			...
			{
				strBuf.Append(" And BGT_D_BUDGET_T_DEPT_I.DATA_ORGANISE_ID ").Append((cause.DATA_ORGANISE_ID.StartsWith("%") || cause.DATA_ORGANISE_ID.EndsWith("%")) ? " like " : " = ").Append(" :DATA_ORGANISE_ID");
			...
			{
				strBuf.Append(cause.GetINSQL("BGT_D_BUDGET_T_DEPT_I", "DATA_ORGANISE_ID"));
			}
			...
			{
				strBuf.Append(" And BGT_D_BUDGET_T_DEPT_I.CREATE_DEPT_ID ").Append((cause.CREATE_DEPT_ID.StartsWith("%") || cause.CREATE_DEPT_ID.EndsWith("%")) ? " like " : " = ").Append(" :CREATE_DEPT_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("BGT_D_BUDGET_T_DEPT_I", "CREATE_DEPT_ID"));
			}
			if(cause.MODIFY_TIME!= null)
			{
				if (cause.MODIFY_TIME.Begin != null)
				{
					strBuf.Append(" And BGT_D_BUDGET_T_DEPT_I.MODIFY_TIME >= :MODIFY_TIME_BEGIN");
					param = new OracleParameter();
				...
				{
					strBuf.Append(" And BGT_D_BUDGET_T_DEPT_I.MODIFY_TIME < :MODIFY_TIME_END");
					param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("BGT_D_BUDGET_T_DEPT_I", "MODIFY_TIME"));
			}
			...
			{
				strBuf.Append(" And BGT_D_BUDGET_T_DEPT_I.STATE = :STATE");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("BGT_D_BUDGET_T_DEPT_I", "STATE"));
			}
			if(!string.IsNullOrEmpty(cause.BUDGET_YEAR))
			{
				strBuf.Append(" And BGT_D_BUDGET_T_DEPT_I.BUDGET_YEAR ").Append((cause.BUDGET_YEAR.StartsWith("%") || cause.BUDGET_YEAR.EndsWith("%")) ? " like " : " = ").Append(" :BUDGET_YEAR");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("BGT_D_BUDGET_T_DEPT_I", "BUDGET_YEAR"));
			}
			if(!string.IsNullOrEmpty(cause.MODIFY_DEPT_ID))
			{
				strBuf.Append(" And BGT_D_BUDGET_T_DEPT_I.MODIFY_DEPT_ID ").Append((cause.MODIFY_DEPT_ID.StartsWith("%") || cause.MODIFY_DEPT_ID.EndsWith("%")) ? " like " : " = ").Append(" :MODIFY_DEPT_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("BGT_D_BUDGET_T_DEPT_I", "MODIFY_DEPT_ID"));
			}
			if(cause.CREATE_TIME!= null)
			{
				if (cause.CREATE_TIME.Begin != null)
				{
					strBuf.Append(" And BGT_D_BUDGET_T_DEPT_I.CREATE_TIME >= :CREATE_TIME_BEGIN");
					param = new OracleParameter();
				...
				{
					strBuf.Append(" And BGT_D_BUDGET_T_DEPT_I.CREATE_TIME < :CREATE_TIME_END");
					param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("BGT_D_BUDGET_T_DEPT_I", "CREATE_TIME"));
			}
			if(!string.IsNullOrEmpty(cause.MODIFY_USER_ID))
			{
				strBuf.Append(" And BGT_D_BUDGET_T_DEPT_I.MODIFY_USER_ID ").Append((cause.MODIFY_USER_ID.StartsWith("%") || cause.MODIFY_USER_ID.EndsWith("%")) ? " like " : " = ").Append(" :MODIFY_USER_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("BGT_D_BUDGET_T_DEPT_I", "MODIFY_USER_ID"));
			}
			if(!string.IsNullOrEmpty(cause.BUDGET_CONTENTS_ID))
			{
				strBuf.Append(" And BGT_D_BUDGET_T_DEPT_I.BUDGET_CONTENTS_ID ").Append((cause.BUDGET_CONTENTS_ID.StartsWith("%") || cause.BUDGET_CONTENTS_ID.EndsWith("%")) ? " like " : " = ").Append(" :BUDGET_CONTENTS_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("BGT_D_BUDGET_T_DEPT_I", "BUDGET_CONTENTS_ID"));
			}
			if(!string.IsNullOrEmpty(cause.CREATE_USER_ID))
			{
				strBuf.Append(" And BGT_D_BUDGET_T_DEPT_I.CREATE_USER_ID ").Append((cause.CREATE_USER_ID.StartsWith("%") || cause.CREATE_USER_ID.EndsWith("%")) ? " like " : " = ").Append(" :CREATE_USER_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("BGT_D_BUDGET_T_DEPT_I", "CREATE_USER_ID"));
			}
			if(!string.IsNullOrEmpty(cause.COMMENTS))
			{
				strBuf.Append(" And BGT_D_BUDGET_T_DEPT_I.COMMENTS ").Append((cause.COMMENTS.StartsWith("%") || cause.COMMENTS.EndsWith("%")) ? " like " : " = ").Append(" :COMMENTS");
				param = new OracleParameter();
			...
			{
				strBuf.Append(cause.GetINSQL("BGT_D_BUDGET_T_DEPT_I", "COMMENTS"));
			}
		...
		public static string PrepareUpdate(EntityObject_BGT_D_BUDGET_T_DEPT_I obj, out OracleParameter[] parameters )
        {
			...
			{
				strBuf.Add("  BGT_D_BUDGET_T_DEPT_I.DATA_ORGANISE_ID = :DATA_ORGANISE_ID");
				param = new OracleParameter();
				param.ParameterName = ":DATA_ORGANISE_ID";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  BGT_D_BUDGET_T_DEPT_I.CREATE_DEPT_ID = :CREATE_DEPT_ID");
				param = new OracleParameter();
				param.ParameterName = ":CREATE_DEPT_ID";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  BGT_D_BUDGET_T_DEPT_I.MODIFY_TIME = :MODIFY_TIME");
				param = new OracleParameter();
			...
			{
				strBuf.Add("  BGT_D_BUDGET_T_DEPT_I.STATE = :STATE");
				param = new OracleParameter();
				param.ParameterName = ":STATE";
				param.OracleType = System.Data.OracleClient.OracleType.Number;
				param.Size = 22;
			...
			{
				strBuf.Add("  BGT_D_BUDGET_T_DEPT_I.BUDGET_YEAR = :BUDGET_YEAR");
				param = new OracleParameter();
				param.ParameterName = ":BUDGET_YEAR";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  BGT_D_BUDGET_T_DEPT_I.MODIFY_DEPT_ID = :MODIFY_DEPT_ID");
				param = new OracleParameter();
				param.ParameterName = ":MODIFY_DEPT_ID";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  BGT_D_BUDGET_T_DEPT_I.MODIFY_USER_ID = :MODIFY_USER_ID");
				param = new OracleParameter();
				param.ParameterName = ":MODIFY_USER_ID";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  BGT_D_BUDGET_T_DEPT_I.BUDGET_CONTENTS_ID = :BUDGET_CONTENTS_ID");
				param = new OracleParameter();
				param.ParameterName = ":BUDGET_CONTENTS_ID";
				param.OracleType = System.Data.OracleClient.OracleType.Char;
				param.Size = 36;
			...
			{
				strBuf.Add("  BGT_D_BUDGET_T_DEPT_I.COMMENTS = :COMMENTS");
				param = new OracleParameter();
				param.ParameterName = ":COMMENTS";
				param.OracleType = System.Data.OracleClient.OracleType.VarChar;
				param.Size = 200;
