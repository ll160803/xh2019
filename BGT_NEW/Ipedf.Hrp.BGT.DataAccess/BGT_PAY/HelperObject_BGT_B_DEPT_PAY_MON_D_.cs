...
namespace Ipedf.Web.DataAccess
{
    ...
    {
        public static DisplayObject_BGT_B_DEPT_PAY_MON_D_EXT[] QueryExt(CauseObject_BGT_B_DEPT_PAY_MON_D cause, PagingParamter paging, OrderByParameter order)
        {
            ...
            #endregion
            string sSql = @" select  BGT_B_DEPT_PAY_MON_D.M_9_VALUE, 
                                     BGT_B_DEPT_PAY_MON_D.ID, 
                                     BGT_B_DEPT_PAY_MON_D.TEMPLET_ITEM_ID, 
                                     BGT_B_DEPT_PAY_MON_D.M_7_VALUE, 
                                     BGT_B_DEPT_PAY_MON_D.M_8_VALUE, 
                                     BGT_B_DEPT_PAY_MON_D.MGR_DEPT_ID, 
                                     BGT_B_DEPT_PAY_MON_D.ITEM_ID, 
                                     BGT_B_DEPT_PAY_MON_D.M_1_VALUE, 
                                     BGT_B_DEPT_PAY_MON_D.M_2_VALUE, 
                                     BGT_B_DEPT_PAY_MON_D.M_10_VALUE, 
                                     BGT_B_DEPT_PAY_MON_D.M_11_VALUE, 
                                     BGT_B_DEPT_PAY_MON_D.M_5_VALUE, 
                                     BGT_B_DEPT_PAY_MON_D.M_3_VALUE, 
                                     BGT_B_DEPT_PAY_MON_D.BASE_ID, 
                                     BGT_B_DEPT_PAY_MON_D.M_12_VALUE, 
                                     BGT_B_DEPT_PAY_MON_D.M_6_VALUE, 
                                     BGT_B_DEPT_PAY_MON_D.M_4_VALUE, 
                                     ...
                                     on BGT_B_DEPT_PAY_MON_D.MGR_DEPT_ID = BGT_D_BUDGET_DEPT_MGR_DEPT_ID.ID 
                                     left join BGT_D_BUDGET_ITEM   BGT_D_BUDGET_ITEM_ITEM_ID 
                                     on BGT_B_DEPT_PAY_MON_D.ITEM_ID = BGT_D_BUDGET_ITEM_ITEM_ID.ID 
                                     left join BILL_WORK_FLOW   BILL_WORK_FLOW_BASE_ID 
                                     on BGT_B_DEPT_PAY_MON_D.BASE_ID = BILL_WORK_FLOW_BASE_ID.ID 
                                     where (1=1)";
            ...
            DisplayObject_BGT_B_DEPT_PAY_MON_D_EXT dataObj = null;
            ArrayList objArray = new ArrayList();
            while (sqlReader.Read())
            {
                dataObj = new DisplayObject_BGT_B_DEPT_PAY_MON_D_EXT();
                ...
                if (!sqlReader.IsDBNull(20))
                    dataObj.UNIT_ID = sqlReader.GetString(20);
                if (!sqlReader.IsDBNull(21))
                    dataObj.UNIT_ID_NAME = sqlReader.GetString(21);
                objArray.Add(dataObj);
            }
            sqlReader.Close();
            IDALProvider.IDAL.PushConnection(connection);
            #endregion
            DisplayObject_BGT_B_DEPT_PAY_MON_D_EXT[] objs = new DisplayObject_BGT_B_DEPT_PAY_MON_D_EXT[objArray.Count];
