...
namespace Ipedf.Web.DataAccess
{
    ...
    {
        public static DisplayObject_BGT_B_DEPT_PLAN_MON_FACT_D_EXT[] QueryExt(CauseObject_BGT_B_DEPT_PLAN_MON_FACT_D cause, PagingParamter paging, OrderByParameter order)
        {
            ...
            #endregion
            string sSql = @" select  BGT_B_DEPT_PLAN_MON_FACT_D.BASE_ID, 
                                     BGT_B_DEPT_PLAN_MON_FACT_D.SOURCE_TYPE_ID, 
                                     BGT_B_DEPT_PLAN_MON_FACT_D.FACT_VALUE, 
                                     BGT_B_DEPT_PLAN_MON_FACT_D.ID, 
                                     BGT_B_DEPT_PLAN_MON_FACT_D.COMMENTS, 
                                     BGT_B_DEPT_PLAN_MON_FACT_D.ITEM_ID, 
                                     ...
                                     from BGT_B_DEPT_PLAN_MON_FACT_D 
                                     left join COM_TYPE   COM_TYPE_SOURCE_TYPE_ID 
                                     on BGT_B_DEPT_PLAN_MON_FACT_D.SOURCE_TYPE_ID = COM_TYPE_SOURCE_TYPE_ID.ID 
                                     left join BGT_D_PLAN_ITEM   BGT_D_PLAN_ITEM_ITEM_ID 
                                     on BGT_B_DEPT_PLAN_MON_FACT_D.ITEM_ID = BGT_D_PLAN_ITEM_ITEM_ID.ID 
                                     ...
                                     on u.item_id = BGT_B_DEPT_PLAN_MON_FACT_D.ITEM_ID 
                                     where (1=1)";
            ...
            DisplayObject_BGT_B_DEPT_PLAN_MON_FACT_D_EXT dataObj = null;
            ArrayList objArray = new ArrayList();
            while (sqlReader.Read())
            {
                dataObj = new DisplayObject_BGT_B_DEPT_PLAN_MON_FACT_D_EXT();
            ...
            #endregion
            DisplayObject_BGT_B_DEPT_PLAN_MON_FACT_D_EXT[] objs = new DisplayObject_BGT_B_DEPT_PLAN_MON_FACT_D_EXT[objArray.Count];
