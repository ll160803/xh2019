<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_YEAR_ADJUST_4.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_YEAR_ADJUST_4" %>
...
<head id="Head1" runat="server">
	...
	<title>BGT_B_DEPT_YEAR_ADJUST</title>
																	...
																	<td>
																		<Com:ComGridView ID="gvDetailList" runat="server" AutoGenerateColumns="False" BorderColor="#b5d6e6" BorderWidth="1px" DbClickEdit="false">
																			<Columns>
							                                                    ...
							                                                    <asp:BoundField DataField="BUDGET_BASE" HeaderText="年初预算" /> 
							                                                    <asp:TemplateField HeaderText="调整数值">
								                                                    <ItemTemplate>
