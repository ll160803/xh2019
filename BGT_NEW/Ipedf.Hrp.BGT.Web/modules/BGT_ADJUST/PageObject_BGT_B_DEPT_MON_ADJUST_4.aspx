<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_MON_ADJUST_4.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_MON_ADJUST_4" %>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr >
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				     <tr >
						...
						<td>
							...
							<asp:BoundField DataField="ADJUST_ID_NAME" HeaderText="调整文号" /> 
				...
				<tr>
					...
					<td>
						<Com:ComBaseBox ID="ddlInputADJUST_ID" runat="server" ></Com:ComBaseBox>
					</td>
					<td colspan=2>&nbsp;</td>
				</tr>
																</table>
							...
							<asp:TemplateField HeaderText="1月调整">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputM_1_VALUE" runat="server" Width="40" ></Com:ComTextBox>
								</ItemTemplate>
							</asp:TemplateField>
							<asp:BoundField DataField="M_1_BASE_VALUE" HeaderText="年初" /> 
							<asp:TemplateField HeaderText="2月调整">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputM_2_VALUE" runat="server" Width="40" ></Com:ComTextBox>
								</ItemTemplate>
							</asp:TemplateField>
							<asp:BoundField DataField="M_2_BASE_VALUE" HeaderText="年初" /> 
							<asp:TemplateField HeaderText="3月调整">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputM_3_VALUE" runat="server" Width="40" ></Com:ComTextBox>
								</ItemTemplate>
							</asp:TemplateField>
							<asp:BoundField DataField="M_3_BASE_VALUE" HeaderText="年初" /> 
							<asp:TemplateField HeaderText="4月调整">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputM_4_VALUE" runat="server" Width="40" ></Com:ComTextBox>
								</ItemTemplate>
							</asp:TemplateField>
							<asp:BoundField DataField="M_4_BASE_VALUE" HeaderText="年初" /> 
							<asp:TemplateField HeaderText="5月调整">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputM_5_VALUE" runat="server" Width="40" ></Com:ComTextBox>
								</ItemTemplate>
							</asp:TemplateField>
							<asp:BoundField DataField="M_5_BASE_VALUE" HeaderText="年初" /> 
							<asp:TemplateField HeaderText="6月调整">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputM_6_VALUE" runat="server" Width="40" ></Com:ComTextBox>
								</ItemTemplate>
							</asp:TemplateField>
							<asp:BoundField DataField="M_6_BASE_VALUE" HeaderText="年初" /> 
							<asp:TemplateField HeaderText="7月调整">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputM_7_VALUE" runat="server" Width="40" ></Com:ComTextBox>
								</ItemTemplate>
							</asp:TemplateField>
							<asp:BoundField DataField="M_7_BASE_VALUE" HeaderText="年初" /> 
							<asp:TemplateField HeaderText="8月调整">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputM_8_VALUE" runat="server" Width="40" ></Com:ComTextBox>
								</ItemTemplate>
							</asp:TemplateField> 
							<asp:BoundField DataField="M_8_BASE_VALUE" HeaderText="年初" /> 
							<asp:TemplateField HeaderText="9月调整">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputM_9_VALUE" runat="server" Width="40" ></Com:ComTextBox>
								</ItemTemplate>
							</asp:TemplateField>
							<asp:BoundField DataField="M_9_BASE_VALUE" HeaderText="年初" /> 
							<asp:TemplateField HeaderText="10月调整">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputM_10_VALUE" runat="server" Width="40" ></Com:ComTextBox>
								</ItemTemplate>
							</asp:TemplateField>
							<asp:BoundField DataField="M_10_BASE_VALUE" HeaderText="年初" />
							<asp:TemplateField HeaderText="11月调整">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputM_11_VALUE" runat="server" Width="40" ></Com:ComTextBox>
								</ItemTemplate>
							</asp:TemplateField>
							<asp:BoundField DataField="M_11_BASE_VALUE" HeaderText="年初" />
							<asp:TemplateField HeaderText="12月调整">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputM_12_VALUE" runat="server" Width="40" ></Com:ComTextBox>
								</ItemTemplate>
							</asp:TemplateField>
							<asp:BoundField DataField="M_12_BASE_VALUE" HeaderText="年初" />
