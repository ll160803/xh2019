<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_BUDGET_ADJUST.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_BUDGET_ADJUST" %>
...
<head runat="server">
	...
	<title>BGT_B_BUDGET_ADJUST</title>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        ...
	        <tr>
	            <td>
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<asp:BoundField DataField="BUDGET_YEAR_NAME" HeaderText="调整基础" />												
							<asp:BoundField DataField="ADJUST_CODE" HeaderText="调整文号" /> 
							<asp:BoundField DataField="ADJUST_NUM" HeaderText="调整序号" /> 
				...
				<tr>
					...
					<td>
						<Com:ComTextBox ID="txtInputADJUST_NUM" runat="server" MaxLength = "50" ></Com:ComTextBox>
					</td>
				</tr>
				<tr>
					<td >
