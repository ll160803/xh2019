<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_BUDGET_ADJUST_Param.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_BUDGET_ADJUST_Param" %>
	                ...
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<tr>
								...
								<td>
									<Com:ComTextBox ID="txtQueryADJUST_CODE" runat="server" MaxLength = "50" ></Com:ComTextBox>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<Com:ComTextBox ID="txtQueryADJUST_NUM" runat="server" MaxLength = "50" ></Com:ComTextBox>
								</td>
							</tr>
							<tr>
								<td>
