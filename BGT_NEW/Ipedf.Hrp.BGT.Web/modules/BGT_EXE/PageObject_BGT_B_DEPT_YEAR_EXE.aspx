<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_YEAR_EXE.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_YEAR_EXE" %>
...
<head id="Head1" runat="server">
	...
	<title>BGT_B_DEPT_YEAR_EXE</title>
				...
				<tr>
					...
					<td>
						<Com:ComDropDownList ID="ddlInputBUDGET_CONTENTS_ID" runat="server" ></Com:ComDropDownList>
							...
							<asp:BoundField DataField="ITEM_FACT_VALUE" HeaderText="执行值" /> 						</Columns>
																			<HeaderStyle CssClass="HeaderStyle"></HeaderStyle>
																			<FooterStyle CssClass="FooterStyle"></FooterStyle>                            
																			<RowStyle CssClass="RowStyle"></RowStyle>
																			<PagerStyle CssClass="PagerStyle"></PagerStyle>
