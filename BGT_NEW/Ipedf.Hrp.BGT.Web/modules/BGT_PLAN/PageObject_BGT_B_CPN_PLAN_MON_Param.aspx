<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_CPN_PLAN_MON_Param.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_CPN_PLAN_MON_Param" %>
...
<head runat="server">
	...
	<title>BGT_B_CPN_PLAN_MON</title>
	                ...
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<tr>
								...
								<td>
									<Com:ComDropDownList ID="ddlQueryBUDGET_MONTH" runat="server" ></Com:ComDropDownList>
								</td>
							</tr>
												</table>
											</div>
