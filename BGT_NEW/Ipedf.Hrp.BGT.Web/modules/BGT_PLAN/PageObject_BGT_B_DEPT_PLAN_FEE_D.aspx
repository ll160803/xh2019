<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_PLAN_FEE_D.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_PLAN_FEE_D" %>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        ...
	        <tr>
	            <td>
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<asp:BoundField DataField="ITEM_VALUE" HeaderText="指标值" /> 
													</Columns>
				...
				<tr>
					...
					<td>
						<Com:ComDropDownList ID="ddlInputITEM_ID" runat="server" ></Com:ComDropDownList>
					</td>
				</tr>
				<tr>
					<td >
