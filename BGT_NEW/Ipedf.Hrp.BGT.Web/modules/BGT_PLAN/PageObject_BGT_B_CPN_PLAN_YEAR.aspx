<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_CPN_PLAN_YEAR.aspx.cs"
    Inherits="Ipedf.Web.PageObject_BGT_B_CPN_PLAN_YEAR" %>
...
<head id="Head1" runat="server">
    ...
    <title>BGT_B_CPN_PLAN_YEAR</title>
                                                            ...
                                                            <div id="basePannel" runat="server">
                                                                <table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <Com:ComDropDownList ID="ddlInputTEMPLET_ID" runat="server">
                                                                            </Com:ComDropDownList>
                                                                        </td>
                                                                        <td colspan="2">
                                                                            &nbsp;
                                                                        ...
                                                                        <td>
                                                                            <Com:ComGridView ID="gvDetailList" runat="server" AutoGenerateColumns="False" BorderColor="#b5d6e6"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="计划值">
                                                                                        <ItemTemplate>
