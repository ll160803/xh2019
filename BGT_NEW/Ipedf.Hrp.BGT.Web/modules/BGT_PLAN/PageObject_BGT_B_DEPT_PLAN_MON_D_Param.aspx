<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_PLAN_MON_D_Param.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_PLAN_MON_D_Param" %>
	                ...
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<tr>
								...
								<td>
									<Com:ComTextBox ID="txtQueryITEM_VALUE" runat="server" MaxLength = "36" ></Com:ComTextBox>
								</td>
							</tr>
												</table>
											</div>
