<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_PLAN_YEAR.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_PLAN_YEAR" %>
...
<head id="Head1" runat="server">
	...
	<title>BGT_B_DEPT_PLAN_YEAR</title>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr >
	                             ...
	                             <table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr >
										...
										<table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellSpacing="0" cellPadding="0">
											...
											<tr>
												<td>
												<Com:ComButton ID="btnCreateContent" runat="server" Text="" OnClick="OnCustom" />&nbsp;
												</td>
											</tr>
										</table>	
										</td>
				...
				<tr>
					...
					<td>
						<Com:ComDropDownList ID="ddlInputTEMPLET_ID" runat="server" ></Com:ComDropDownList>
					</td>
					<td >
						...
						<Com:ComBaseBox ID="ddlInputBUDGET_DEPT_ID" runat="server" ></Com:ComBaseBox>
													...
													<tr>
														<td >
															...
															<table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellSpacing="0" cellPadding="0">	
																<tr>
																	<td><Com:ComGridView ID="gvDetailList" runat="server" AutoGenerateColumns="False" BorderColor="#b5d6e6" BorderWidth="1px" DbClickEdit="false">
																			<Columns>
																				<asp:BoundField DataField="ID" SortExpression="ID" Visible="False" />
																				<asp:TemplateField HeaderText="V">
																					<headertemplate>
																							<INPUT id="Checkbox1" type="checkbox" onclick="selectAll('gvDetailList');" />
																						</headertemplate>
																					<ItemTemplate>
																						<asp:CheckBox ID="cbSelect" runat="server" />
																					</ItemTemplate>
							                                                    ...
							                                                    <asp:TemplateField HeaderText="指标值">
								                                                    <ItemTemplate>
									                                                    <Com:ComTextBox ID="txtInputITEM_VALUE" runat="server" ></Com:ComTextBox>
								                                                    </ItemTemplate>
							                                                    </asp:TemplateField>							                                            						                                        
							                                                    <asp:BoundField DataField="BUDGET_BASE" HeaderText="预算基础" /> 						                                                   
																		...
																		<Com:ComDropDownList ID="ddlDataSourceITEM_ID" runat="server" Visible="false"/></td>
																</tr>
																 <tr>
                                                                        <td>
                                                                            <a href="../../Template/bgt/PageObject_BGT_B_DEPT_PLAN_YEAR.xls" onclick="javascript:void(0);"
