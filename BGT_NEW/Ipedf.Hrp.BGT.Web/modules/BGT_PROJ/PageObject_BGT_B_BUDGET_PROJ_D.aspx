<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_BUDGET_PROJ_D.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_BUDGET_PROJ_D" %>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        ...
	        <tr>
				...
				<tr>
					...
					<td>
						<Com:ComTextBox ID="txtInputBUDEGT_MONEY" runat="server" ></Com:ComTextBox>
									<asp:RegularExpressionValidator ID="revtxtInputBUDEGT_MONEY" runat="server" ControlToValidate="txtInputBUDEGT_MONEY" ErrorMessage="" ValidationExpression="^[-]{0,1}[0-9]+(.[0-9]{1,})?$">请输入正确的小数</asp:RegularExpressionValidator>
					</td>
				</tr>
				<tr>
					<td >
					...
					<td>
						<Com:ComTextBox ID="txtInputEXECUTED_MONEY" runat="server" ></Com:ComTextBox>
									<asp:RegularExpressionValidator ID="revtxtInputEXECUTED_MONEY" runat="server" ControlToValidate="txtInputEXECUTED_MONEY" ErrorMessage="" ValidationExpression="^[-]{0,1}[0-9]+(.[0-9]{1,})?$">请输入正确的小数</asp:RegularExpressionValidator>
					</td>
				</tr>
				<tr>
					<td >
				...
				<tr>
					...
					<td>
						<Com:ComTextBox ID="txtInputAPPLIED_MONEY" runat="server" ></Com:ComTextBox>
									<asp:RegularExpressionValidator ID="revtxtInputAPPLIED_MONEY" runat="server" ControlToValidate="txtInputAPPLIED_MONEY" ErrorMessage="" ValidationExpression="^[-]{0,1}[0-9]+(.[0-9]{1,})?$">请输入正确的小数</asp:RegularExpressionValidator>
					</td>
				</tr>
				<tr>
					<td >
					...
					<td>
						<Com:ComDropDownList ID="ddlInputSOURCE_ID" runat="server" ></Com:ComDropDownList>
					</td>
				</tr>				
												</table>
											</div>
