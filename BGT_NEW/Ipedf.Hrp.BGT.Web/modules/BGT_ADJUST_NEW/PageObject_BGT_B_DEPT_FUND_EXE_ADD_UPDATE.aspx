<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_FUND_EXE_ADD_UPDATE.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_FUND_EXE_ADD_UPDATE" %>
                                            ...
                                            <div id="resultPannel" runat="server">
                                                <BGT:BGTComGridView ID="gvResultList" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="CONTROL_MONEY" HeaderText="控制数" HeaderStyle-ForeColor="Red" />
                                                            ...
                                                            <div id="basePannel" runat="server">
                                                                <table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <Com:ComBaseBox ID="ddlInputDEPT_USER_ID" runat="server" Enabled="false"></Com:ComBaseBox>
                                                                        </td>
                                                                        <td>
                                                                            <nobr>申请年度</nobr>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3">
                                                                            <Com:ComBaseBox ID="ddlInputBGT_D_BUDGET_ITEM_ID" Width="80%" runat="server" Enabled="false">
                                                                            </Com:ComBaseBox>
                                                                        </td>
                                                                        <td>
                                                                            <nobr>经费类别</nobr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <Com:ComTextBox ID="txtInputCODE" runat="server" MaxLength="50">
                                                                            </Com:ComTextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="5">
                                                                            <Com:ComTextBox ID="txtInputDECALRE_CAUSE" Enabled="false" TextMode="MultiLine" Columns="20"
                                                                        ...
                                                                        <td>
                                                                            <Com:ComGridView ID="gvDetailList" runat="server" AutoGenerateColumns="False" BorderColor="#b5d6e6"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="预算工作委员会办公室核定数">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtCONTROL_MONEY" runat="server"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="预算工作委员会办公室意见">
                                                                                        <ItemTemplate>
