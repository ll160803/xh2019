<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_FUND_EXE_ADD_UPDATE_2.aspx.cs"
    Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_FUND_EXE_ADD_UPDATE_2" %>
                                            ...
                                            <table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td><Com:ComButton ID="btnDelete" runat="server" Text="删除" />&nbsp;
                                                        &nbsp;<asp:Button
                                                            runat="server" ID="btnExport" Text="导出" OnClick="OnExport" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                                                            ...
                                                                            <Com:ComGridView ID="gvDetailList" runat="server" AutoGenerateColumns="False" BorderColor="#b5d6e6"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="计划完成时间">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputCOMPLETE_TIME" runat="server"></Com:ComTextBox><img style="cursor: hand"
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="财务意见" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputFINANCE_IDEA" TextMode="MultiLine" Font-Size="12px" Columns="30"
                                                                                                Rows="2" Width="96%" Height="35px" runat="server" Enabled="false"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
