	                    ...
	                    <tr>
							...
							<tr>
								...
								<td>
									...
									<asp:RegularExpressionValidator ID="revtxtQueryEXE_MONEY" runat="server" ControlToValidate="txtQueryEXE_MONEY" ErrorMessage="" ValidationExpression="^[-]{0,1}[0-9]+(.[0-9]{1,})?$">请输入正确的小数</asp:RegularExpressionValidator>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									...
									<asp:RegularExpressionValidator ID="revtxtQueryCHANGE_MONEY" runat="server" ControlToValidate="txtQueryCHANGE_MONEY" ErrorMessage="" ValidationExpression="^[-]{0,1}[0-9]+(.[0-9]{1,})?$">请输入正确的小数</asp:RegularExpressionValidator>
								</td>
							</tr>
							<tr>
								<td>
