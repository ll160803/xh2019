				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				     <tr >
						...
						<td>
							...
							<asp:BoundField DataField="DEPT_USER_ID_NAME" HeaderText="部门负责人" /> 
							<asp:BoundField DataField="DECALRE_CAUSE" HeaderText="申请说明" /> 
				...
				<tr>
					...
					<td>
						<Com:ComTextBox ID="txtInputFUND_MONEY" runat="server" ></Com:ComTextBox>
									<asp:RegularExpressionValidator ID="revtxtInputFUND_MONEY" runat="server" ControlToValidate="txtInputFUND_MONEY" ErrorMessage="" ValidationExpression="^[-]{0,1}[0-9]+(.[0-9]{1,})?$">请输入正确的小数</asp:RegularExpressionValidator>
					</td>
				</tr>
				<tr>
					<td >
				...
				<tr>
					...
					<td>
						<Com:ComTextBox ID="txtInputFINANCE_IDEA" runat="server" MaxLength = "500" ></Com:ComTextBox>
							...
							<asp:TemplateField HeaderText="设备ID">
								<ItemTemplate>
							...
							<asp:TemplateField HeaderText="一般经费名称">
								<ItemTemplate>
							...
							<asp:TemplateField HeaderText="建筑名称">
								<ItemTemplate>
