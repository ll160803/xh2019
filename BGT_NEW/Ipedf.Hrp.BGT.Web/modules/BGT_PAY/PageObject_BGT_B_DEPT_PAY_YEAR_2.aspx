<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_PAY_YEAR_2.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_PAY_YEAR_2" %>
...
<head id="Head1" runat="server">
	...
	<title>BGT_B_DEPT_PAY_YEAR</title>
					...
					<td>
						<Com:ComBaseBox ID="ddlInputBUDGET_DEPT_ID" runat="server" ></Com:ComBaseBox>
																	...
																	<td>
																		<Com:ComGridView ID="gvDetailList" runat="server" AutoGenerateColumns="False" BorderColor="#b5d6e6" BorderWidth="1px" DbClickEdit="false">
																			<Columns>
							                                                    ...
							                                                    <asp:BoundField DataField="MGR_DEPT_ID_NAME" HeaderText="职能科室" /> 
							                                                    <asp:TemplateField HeaderText="计划数值">
								                                                    <ItemTemplate>
							...
							<Com:ComDropDownList ID="ddlDataSourceITEM_ID" runat="server" Visible="false"/>
																...
																<tr>
                                                                        <td>
                                                                            <a href="../../Template/bgt/PageObject_BGT_B_DEPT_PAY_YEAR_2.xls" onclick="javascript:void(0);"
