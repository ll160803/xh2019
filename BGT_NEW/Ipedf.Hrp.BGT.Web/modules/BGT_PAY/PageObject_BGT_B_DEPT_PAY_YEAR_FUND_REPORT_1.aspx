<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_PAY_YEAR_FUND_REPORT_1.aspx.cs"
    Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_PAY_YEAR_FUND_REPORT_1" %>
                        ...
                        <tr>                            
                            <td align="left">
                               <nobr>预算年度:</nobr><Com:ComDropDownList ID="ddlQueryBUDGET_YEAR" runat="server" AutoPostBack="true" OnSelectedIndexChanged ="ddlQueryBUDGET_YEAR_Changed"></Com:ComDropDownList>
                                <nobr>部门:</nobr><Com:ComBaseBox ID="ddlBUDGET_DEPT_ID" runat="server"></Com:ComBaseBox> &nbsp;<asp:Button runat="server" ID="btnSearch" OnClick="OnQuery" Text="查询" />&nbsp;<asp:Button runat="server" ID="btnOut" OnClick="btnOutExcel_Click" Text="导出" />
                            </td>
                        </tr>
                        <tr>
                            <td >
