<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_CPN_PAY_YEAR.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_CPN_PAY_YEAR" %>
...
<head id="Head1" runat="server">
	...
	<title>BGT_B_CPN_PAY_YEAR</title>
				...
				<tr>
					...
					<td colspan=2>&nbsp;</td>
							...
							<Com:ComDropDownList ID="ddlDataSourceITEM_ID" runat="server" Visible="false"/>
																...
																<tr>
                                                                        <td>
                                                                            <a href="../../Template/bgt/PageObject_BGT_B_DEPT_INC_DATA.xls" onclick="javascript:void(0);"
