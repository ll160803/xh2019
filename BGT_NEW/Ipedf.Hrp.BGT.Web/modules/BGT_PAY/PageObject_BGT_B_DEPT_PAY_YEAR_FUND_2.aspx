<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_PAY_YEAR_FUND_2.aspx.cs"
    Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_PAY_YEAR_FUND_2" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function() { $('#file_upload').uploadify({ 'swf': '../../scripts/uploadify/uploadify.swf', 'uploader': '/shell_BGT/modules/Upload.aspx', 'auto': true, 'buttonText': '浏   览', 'fileSizeLimit': '5000KB', 'fileTypeExts': '*.gif; *.jpg; *.png;*.doc;*.docx;*.xls;*.xlsx;', 'progressData': 'speed', 'queueID': 'fileQueue', 'queueInit': [], 'queueInitID': 'upFiles_file_upload', 'removeCompleted': true, 'onFallback': function() { alert('没有检测到Adobe Flash插件，请安装后再尝试上传.'); }, 'onUploadSuccess': function(file, data, response) { AddqueueInit(file, data, response); } }); });
    </script>
                                                            ...
                                                            <div id="basePannel" runat="server">
                                                                <table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <Com:ComDropDownList ID="ddlInputIS_AGREE" AutoPostBack="true" OnSelectedIndexChanged="ddlInputIS_AGREE_Change" onchange="onselchange(this.value)" runat="server">
                                                                            </Com:ComDropDownList>
                                                                        </td>
                                                                        <td>
                                                                        </td>
                                                        ...
                                                        <td>
                                                            <div id="detailPannel" runat="server">
                                                                <table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellspacing="0"
                                                                        ...
                                                                        <td>
                                                                            <Com:ComGridView ID="gvDetailList" runat="server" AutoGenerateColumns="False" BorderColor="#b5d6e6"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="支出明细">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputBUILDING_NAME" TextMode="MultiLine" Font-Size="12px"
                                                                                                Columns="30" Rows="2" Width="96%" Height="35px" runat="server" onchange="ontextchange()"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="一上计划支出金额">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputMONEY" Width="100" runat="server" txtInputMONEY onchange="ontextchange()"></Com:ComTextBox>元
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="计划完成时间">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputCOMPLETE_TIME" Width="100" runat="server"></Com:ComTextBox><img style="cursor: hand"
                                                                                                onclick="tableClick(this)" src="../../images/calender.gif">
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="依据说明">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputDECLARE_CAUSE" TextMode="MultiLine" Font-Size="12px"
                                                                                                Columns="30" Rows="2" Width="96%" Height="35px" runat="server"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="二上计划支出金额" >
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputMONEY1" Width="100"  runat="server" txtInputMONEY1 onchange="ontextchange1()"></Com:ComTextBox>元
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a href="../../Template/bgt/PageObject_BGT_B_DEPT_PAY_YEAR_FUND_2.xls" onclick="javascript:void(0);"
