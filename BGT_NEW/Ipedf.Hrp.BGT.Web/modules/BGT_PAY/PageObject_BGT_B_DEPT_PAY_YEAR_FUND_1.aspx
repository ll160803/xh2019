<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_PAY_YEAR_FUND_1.aspx.cs"
    Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_PAY_YEAR_FUND_1" %>
                                            ...
                                            <div id="resultPannel" runat="server">
                                                <Com:ComGridView ID="gvResultList" runat="server" AutoGenerateColumns="False" BorderColor="#b5d6e6"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="IS_PERFORMANCE_NAME" HeaderText="是否为绩效考核项" />
                                                            ...
                                                            <div id="basePannel" runat="server">
                                                                <table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <Com:ComTextBox ID="txtInputFUND_MONEY" runat="server" onfocus="this.blur()">
                                                                            </Com:ComTextBox>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <td>
                                                                            <Com:ComTextBox ID="txtInputFUND_MONEY1" runat="server" Enabled="false" onfocus="this.blur()">
                                                                            </Com:ComTextBox>
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="支出明细" >
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <Com:ComTextBox ID="txtInputFUND_NAME" TextMode="MultiLine" Font-Size="12px" Columns="30" Rows="10" Width="96%" Height="35px" runat="server" onchange="ontextchange()"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="一上申请金额" >
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputMONEY" Width="100"  runat="server"  onchange="ontextchange()" txtInputMONEY></Com:ComTextBox>元
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="预算办公室一下调整金额">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputCONTROL_MONEY" Width="100" Enabled="false" runat="server"  txtInputCONTROL_MONEY></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                ...
                $("#gvDetailList [cbSelect] input").change(showedit);
                                                                        ...
                                                                        function ontextchange() {
                                                                            ...
                                                                            $("#gvDetailList [txtInputMONEY]").each(function () {
                                                                                ...
                                                                                //console.dir($(this).parent().parent().children().first().children().first())
                                                                                //console.dir($(this).parent().parent().find("[type='checkbox']"))
                                                                             ...
                                                                             console.log($("#txtInputFUND_MONEY").attr("disabled"));
                                                                           ...
                                                                           function ontextchange1() {
                                                                               ...
                                                                               console.log($("#txtInputFUND_MONEY1").attr("disabled"));
