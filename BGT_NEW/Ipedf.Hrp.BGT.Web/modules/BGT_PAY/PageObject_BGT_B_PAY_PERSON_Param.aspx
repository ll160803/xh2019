	                    ...
	                    <tr>
							...
							<tr>
								...
								<td>
									...
									<asp:RegularExpressionValidator ID="revtxtQueryIS_USABLE" runat="server" ControlToValidate="txtQueryIS_USABLE" ErrorMessage="" ValidationExpression="^[-]{0,1}[0-9]+(.[0-9]{1,})?$">请输入正确的小数</asp:RegularExpressionValidator>
								</td>
							</tr>
							<tr>
								<td>
