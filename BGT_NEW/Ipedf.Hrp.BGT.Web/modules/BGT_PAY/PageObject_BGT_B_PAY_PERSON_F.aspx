<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_PAY_PERSON_F.aspx.cs"
    Inherits="Ipedf.Web.PageObject_BGT_B_PAY_PERSON_F" %>
                                                            ...
                                                            <div id="basePannel" runat="server">
                                                                <table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <Com:ComTextBox ID="txtInputFINANCE_IDEA" runat="server" Width="96%" Height="35px" Columns="20" Rows="2" MaxLength="500"></Com:ComTextBox>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                                            ...
                                                                            <Com:ComGridView ID="gvDetailList" runat="server" AutoGenerateColumns="False" BorderColor="#b5d6e6"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="类型">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComBaseBox ID="txtInputPERSON_TYPE_ID" Enabled="false" runat="server"></Com:ComBaseBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="2016年">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputLASTYEAR_COUNT" Enabled="false" runat="server"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="2017">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputNOWYEAR_COUNT" Enabled="false" runat="server"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="变动说明及依据">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputDECLARE_CAUSE" Enabled="false" runat="server"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="其他">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputOTHERS" Enabled="false" runat="server"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
