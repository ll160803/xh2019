<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_PAY_YEAR_FUND_f1.aspx.cs"
    Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_PAY_YEAR_FUND_f1" %>
...
<body topmargin="0" leftmargin="0">
                                                            ...
                                                            <div id="basePannel" runat="server">
                                                                <table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <%--<Com:ComBaseBox ID="ddlInputBUDGET_DEPT_ID" runat="server" ClientFunction="selectdept"></Com:ComBaseBox>--%> <Com:ComDropDownList ID="ddlInputBUDGET_DEPT_ID" OnSelectedIndexChanged ="ddlInputBUDGET_DEPT_ID_Change" Height="24" AutoPostBack = "true" runat="server"></Com:ComDropDownList>
                                                                        </td>
                                                                        <td>
                                                                            <nobr>部门负责人</nobr>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <Com:ComTextBox ID="txtInputCONTROL_MONEY" ForeColor="Red"  runat="server"  >
                                                                            </Com:ComTextBox>
                                                                        </td>
                                                                        <td>
                                                                            <nobr>是否同意调整</nobr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <td>
                                                                            <Com:ComTextBox ID="txtInputCONTROL_MONEY1" ForeColor="Red"  runat="server" >
                                                                            </Com:ComTextBox>
                                                                        </td>
                                                                        <td>
                                                                            <nobr>经费编码</nobr>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="支出内容">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputFUND_NAME" TextMode="MultiLine" Font-Size="12px" Columns="20"
                                                                                                Rows="10" Width="96%" Height="35px" runat="server" Enabled="false"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="一上申请金额">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputMONEY" Enabled="false" Width="100" runat="server" txtInputMONEY onchange="onmoneychange()"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="依据说明">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputDECLARE_CAUSE" TextMode="MultiLine" Font-Size="12px"
                                                                                                Columns="20" Rows="10" Width="96%" Height="35px" Enabled="false" runat="server"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
    ...
    <script type="text/javascript">
        function selectdept() {
            debugger
            var dept = $('#ddlInputBUDGET_DEPT_ID').combobox('getValue');
        }
    </script>
</body>
</html>
