<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_CPN_INC_PERSONFUND_Param.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_CPN_INC_PERSONFUND_Param" %>
	                ...
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<tr>
								...
								<td>
									<Com:ComBaseBox ID="ddlQueryDEPT_ID" runat="server" ></Com:ComBaseBox>
								</td>
							</tr>
												</table>
											</div>
