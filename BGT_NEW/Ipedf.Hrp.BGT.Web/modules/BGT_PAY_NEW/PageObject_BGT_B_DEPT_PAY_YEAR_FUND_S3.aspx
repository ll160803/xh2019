<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_PAY_YEAR_FUND_S3.aspx.cs"
    Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_PAY_YEAR_FUND_S3" %>
                                                            ...
                                                            <div id="basePannel" runat="server">
                                                                <table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <Com:ComTextBox ID="txtInputCONTROL_MONEY" runat="server" Enabled="false">
                                                                            </Com:ComTextBox>
                                                                        </td>
                                                                        <td>
                                                                            <nobr>经费编码</nobr>
                                                                            ...
                                                                            <Com:ComGridView ID="gvDetailList" runat="server" AutoGenerateColumns="False" BorderColor="#b5d6e6"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="V">
                                                                                     ...
                                                                                     <asp:BoundField DataField="F_ASSET_NAME"  HeaderText="核定设备名称" />
                                                                                    <asp:BoundField DataField="F_PRICE"  HeaderText="核定价格" />
                                                                                    <asp:BoundField DataField="F_AMOUNT"  HeaderText="核定数量" />
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="设备名称">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputASSET_NAME" Font-Size="12px" runat="server"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="设备单价">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputPRICE" Width="60"  runat="server"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="设备数量">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputAMOUNT" Width="60"  runat="server"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="依据说明">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputDECLARE_CAUSE" TextMode="MultiLine" Columns="20" Rows="2"
                                                                                                Width="96%" Height="35px" Font-Size="12px"  runat="server"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="预算工作委员会办公室意见" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputFINANCE_IDEA" Enabled="false" TextMode="MultiLine" Columns="20" Rows="2"
                                                                                                Width="96%" Height="35px" Font-Size="12px" runat="server"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                </Columns>
