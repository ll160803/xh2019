<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_BUDGET_YEAR_R_I.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_D_BUDGET_YEAR_R_I" %>
...
<body topmargin="0" leftmargin="0">
    ...
    <div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
		     <tr>
	            <td height="30" >
	                <Com:ComControlBar ID="command" runat="server" HandoverState="False" />
	            </td>	               
	        </tr>
           <tr >
				<td  >
