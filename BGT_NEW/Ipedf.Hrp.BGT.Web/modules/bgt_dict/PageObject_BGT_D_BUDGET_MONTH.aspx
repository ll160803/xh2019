<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_BUDGET_MONTH.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_D_BUDGET_MONTH" %>
	                ...
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<asp:TemplateField HeaderText="月份">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputBUDGET_MONTH" runat="server" ></Com:ComTextBox>
								</ItemTemplate>
							</asp:TemplateField>     
												</Columns>
