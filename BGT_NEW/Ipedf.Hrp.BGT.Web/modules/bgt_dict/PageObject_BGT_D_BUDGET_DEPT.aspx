                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <td valign="top" style="table-layout: fixed; width: 80%;">
                                            <div runat="server" id="resultPannel">
                                                <Com:ComGridView ID="gvList" runat="server" AutoGenerateColumns="False" BorderColor="#b5d6e6"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="CODE" HeaderText="科室编码" />
                                                        <asp:BoundField DataField="NAME" HeaderText="科室名称" />
                                                        <asp:BoundField DataField="DEPT_PROPERTY_ID_NAME" HeaderText="科室属性" />
                                                        <asp:BoundField DataField="DEPT_TYPE_ID_NAME" HeaderText="科室类别" />
                                                        <asp:BoundField DataField="IS_FUNCTION_NAME" HeaderText="是否职能科室" />
                                                        ...
                                                        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="PageObject_BGT_D_BUDGET_DEPT_USER.aspx?linkid={0}"
                                                            Text="用户授权" HeaderText="用户授权" Target="_blank" />
                                                        <asp:HyperLinkField Visible="false" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="PageObject_BGT_D_BUDGET_DEPT_BUDGET_ITEM.aspx?linkid={0}"
                                                            Text="预算经费授权" HeaderText="预算经费授权" Target="_blank" />
                                                        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="PageObject_BGT_D_BUDGET_DEPT_CONTROLSTAGE.aspx?linkid={0}"
                                                            Text="阶段控制" HeaderText="阶段控制" Target="_blank" />
                                                    </Columns>
                                            ...
                                            <div id="editPannel" runat="server">
                                                <table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <nobr><span style="color:Red">科室编码</span></nobr>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <nobr><span style="color:Red">科室名称</span></nobr>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <nobr><span style="color:Red">是否职能科室</span></nobr>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <nobr><span style="color:Red">对应部门</span></nobr>
                                                        </td>
                                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <asp:Button ID="btnUpload" runat="server" Text="导入" Style="height: 26px" OnClick="btnUpload_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
