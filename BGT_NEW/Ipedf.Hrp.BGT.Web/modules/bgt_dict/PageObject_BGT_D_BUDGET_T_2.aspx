<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_BUDGET_T_2.aspx.cs"
    Inherits="Ipedf.Web.PageObject_BGT_D_BUDGET_T_2" %>
                                                            ...
                                                            <div id="basePannel" runat="server">
                                                                <table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <Com:ComDropDownList ID="ddlInputBUDGET_CONTENTS_ID" runat="server">
                                                                            </Com:ComDropDownList>
                                                                        </td>
                                                                        <td>
                                                                            <nobr>模板分类</nobr>
                                                                        ...
                                                                        <td>
                                                                            <Com:ComDropDownList ID="ddlInputTEMPLET_TYPE_ID" runat="server">
                                                                            </Com:ComDropDownList>
                                                                        </td>
                                                                        <td colspan="2">
                                                                            &nbsp;
                                                        ...
                                                        <td>
                                                            <div id="detailPannel" runat="server">
                                                                <table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellspacing="0"
                                                                            ...
                                                                            <Com:ComGridView ID="gvDetailList" runat="server" AutoGenerateColumns="False" BorderColor="#b5d6e6"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="计算方法">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComDropDownList ID="ddlInputCALCULATE_METHOD_ID" runat="server">
                                                                                            </Com:ComDropDownList>
                                                                                            <input type="textbox" style="width: 40px;" onkeyup="SearchValue(this,document.getElementById('ddlInputCALCULATE_METHOD_ID'));" />
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="编制方法">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComDropDownList ID="ddlInputPREPARE_METHOD_ID" runat="server">
                                                                                            </Com:ComDropDownList>
                                                                                            <input type="textbox" style="width: 40px;" onkeyup="SearchValue(this,document.getElementById('ddlInputPREPARE_METHOD_ID'));" />
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                </Columns>
                                                                                <HeaderStyle CssClass="HeaderStyle"></HeaderStyle>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a href="../../Template/bgt/PageObject_BGT_D_BUDGET_T2.xls" onclick="javascript:void(0);"
