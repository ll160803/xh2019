<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_VERIFICATION.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_D_VERIFICATION" %>
...
<head runat="server">
	...
	<title>BGT_D_VERIFICATION</title>
	            ...
	            <td>
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<asp:BoundField DataField="ITEM_TYPE_ID_NAME" HeaderText="核销项类型" /> 
							<asp:BoundField DataField="IMPORT_TYPE_ID_NAME" HeaderText="导入方式" /> 
							<asp:BoundField DataField="SOURCE_TYPE_ID_NAME" HeaderText="数据来源类型" /> 
													</Columns>
