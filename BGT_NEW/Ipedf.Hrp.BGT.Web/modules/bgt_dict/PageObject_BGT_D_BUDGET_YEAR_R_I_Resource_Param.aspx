<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_BUDGET_YEAR_R_I_Resource_Param.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_D_BUDGET_YEAR_R_I_Resource_Param" %>
...
<head runat="server">
	...
	<title>BGT_D_BUDGET_YEAR_R_I</title>
	                ...
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<tr>
								...
								<td>
									<Com:ComDropDownList ID="ddlQueryRESOLVE_METHOD_ID" runat="server" ></Com:ComDropDownList>
								</td>
							</tr>
												</table>
											</div>
