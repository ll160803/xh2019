<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_BUDGET_DEPT_BUDGET_ITEM_Resource_Param.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_D_BUDGET_DEPT_BUDGET_ITEM_Resource_Param" %>
	                ...
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<tr>
								...
								<td>
									<Com:ComTextBox ID="txtQueryNAME" runat="server" ></Com:ComTextBox>
								</td>
							</tr>
												</table>
											</div>
