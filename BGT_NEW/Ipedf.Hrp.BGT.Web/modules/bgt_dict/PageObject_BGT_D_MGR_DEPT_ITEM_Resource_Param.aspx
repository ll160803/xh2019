<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_MGR_DEPT_ITEM_Resource_Param.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_D_MGR_DEPT_ITEM_Resource_Param" %>
	                ...
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<tr>
								...
								<td>
									<Com:ComDropDownList ID="ddlQueryDEPT_PROPERTY_ID" runat="server" ></Com:ComDropDownList>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<Com:ComDropDownList ID="ddlQueryDEPT_TYPE_ID" runat="server" ></Com:ComDropDownList>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<Com:ComDropDownList ID="ddlQueryIS_FUNCTION" runat="server" ></Com:ComDropDownList>
								</td>
							</tr>
												</table>
											</div>
