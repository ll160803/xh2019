<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_FEE_ITEM.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_D_FEE_ITEM" %>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        ...
	        <tr>
				...
				<tr>
					...
					<td>
						<Com:ComDropDownList ID="ddlInputIS_CALCULATE" runat="server" ></Com:ComDropDownList><input type="textbox" style="width:40px;" onkeyup="SearchValue(this,window.event.srcElement.previousSibling);" />
					</td>
				</tr>				
				<tr>
					<td >
				...
				<tr>
					...
					<td>
						<Com:ComDropDownList ID="ddlInputIS_DISABLE" runat="server" ></Com:ComDropDownList><input type="textbox" style="width:40px;" onkeyup="SearchValue(this,window.event.srcElement.previousSibling);" />
					</td>
				</tr>	
												</table>
											</div>																	
