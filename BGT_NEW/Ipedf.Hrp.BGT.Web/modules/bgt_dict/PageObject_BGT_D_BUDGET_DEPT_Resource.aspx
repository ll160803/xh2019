<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_BUDGET_DEPT_Resource.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_D_BUDGET_DEPT_Resource" %>
	            ...
	            <td>
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<asp:BoundField DataField="TYPE_NAME" HeaderText="组织类型" /> 
							<asp:BoundField DataField="FAX" HeaderText="传真" /> 
							<asp:BoundField DataField="PHONE" HeaderText="电话" /> 
							<asp:BoundField DataField="DROP_DATE" HeaderText="撤销日期" DataFormatString="{0:yyyy-MM-dd}"/> 
							<asp:BoundField DataField="CREATE_DATE" HeaderText="成立日期" DataFormatString="{0:yyyy-MM-dd}"/> 
							<asp:BoundField DataField="CODE" HeaderText="编码" /> 
							<asp:BoundField DataField="ADDRESS" HeaderText="地址" /> 
							<asp:BoundField DataField="POST_CODE" HeaderText="邮政编码" /> 
													</Columns>
