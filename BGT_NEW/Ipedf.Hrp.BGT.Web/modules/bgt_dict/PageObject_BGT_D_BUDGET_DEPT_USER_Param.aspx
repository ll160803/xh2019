<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_BUDGET_DEPT_USER_Param.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_D_BUDGET_DEPT_USER_Param" %>
	                ...
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<tr>
								...
								<td>
									<Com:ComBaseBox ID="ddlQueryUSER_ID" runat="server" ></Com:ComBaseBox>
								</td>
							</tr>
												</table>
											</div>
