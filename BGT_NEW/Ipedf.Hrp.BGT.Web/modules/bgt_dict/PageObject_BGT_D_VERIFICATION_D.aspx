<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_VERIFICATION_D.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_D_VERIFICATION_D" %>
...
<head runat="server">
	...
	<title>BGT_D_VERIFICATION_D</title>
	            ...
	            <td>
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<asp:BoundField DataField="ITEM_ID_NAME" HeaderText="核销科目" /> 
													</Columns>
