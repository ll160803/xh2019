<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_BUDGET_T_AX.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_D_BUDGET_T_AX" %>
				...
				<tr>
					...
					<td colspan=2>&nbsp;</td>
							...
							<Com:ComDropDownList ID="ddlDataSourceBUDGET_DEPT_ID" runat="server" Visible="false"/>
																...
																<tr>
                                                                        <td>
                                                                            <a href="../../Template/bgt/PageObject_BGT_D_BUDGET_T_AX.xls" onclick="javascript:void(0);"
