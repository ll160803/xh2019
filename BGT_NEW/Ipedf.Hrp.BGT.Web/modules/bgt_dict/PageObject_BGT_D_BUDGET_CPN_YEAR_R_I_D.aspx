<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_BUDGET_CPN_YEAR_R_I_D.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_D_BUDGET_CPN_YEAR_R_I_D" %>
	            ...
	            <td>
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<asp:BoundField DataField="ADJUST_SCALE" HeaderText="调节比例" /> 
				...
				<tr>
					...
					<td>
						<Com:ComTextBox ID="txtInputADJUST_SCALE" runat="server" ></Com:ComTextBox>
									<asp:RegularExpressionValidator ID="revtxtInputADJUST_SCALE" runat="server" ControlToValidate="txtInputADJUST_SCALE" ErrorMessage="" ValidationExpression="^[-]{0,1}[0-9]+(.[0-9]{1,})?$">请输入正确的小数</asp:RegularExpressionValidator>
					</td>
				</tr>
				<tr>
					<td >
					...
					<td>
						<Com:ComBaseBox ID="ddlInputBUDGET_MONTH" runat="server" ></Com:ComBaseBox>
					</td>
				</tr>				
												</table>
											</div>
