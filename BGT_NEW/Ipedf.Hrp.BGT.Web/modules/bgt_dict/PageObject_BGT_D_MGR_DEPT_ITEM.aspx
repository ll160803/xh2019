<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_MGR_DEPT_ITEM.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_D_MGR_DEPT_ITEM" %>
...
<head id="Head1" runat="server">
	...
	<title>BGT_D_MGR_DEPT_ITEM</title>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr >
				...
				<tr>
					...
					<td >
						<nobr><span style="color:Red">职能科室</span></nobr>
					</td>
					<td>
						<Com:ComBaseBox ID="ddlInputMGR_DEPT_ID" runat="server" ></Com:ComBaseBox>
					</td>
					<td >
						<nobr><span style="color:Red">预算科目</span></nobr>
					</td>
					<td>
						<Com:ComBaseBox ID="ddlInputITEM_ID" runat="server" ></Com:ComBaseBox>
							...
							<asp:BoundField DataField="BIZ_DEPT_ID_NAME" HeaderText="业务科室" />                      
																			</Columns>
																			<HeaderStyle CssClass="HeaderStyle"></HeaderStyle>
																			<FooterStyle CssClass="FooterStyle"></FooterStyle>                            
																			<RowStyle CssClass="RowStyle"></RowStyle>
							...
							<Com:ComDropDownList ID="ddlDataSourceBIZ_DEPT_ID" runat="server" Visible="false"/>
																	</td>
																</tr>
															</table>
															</div>
