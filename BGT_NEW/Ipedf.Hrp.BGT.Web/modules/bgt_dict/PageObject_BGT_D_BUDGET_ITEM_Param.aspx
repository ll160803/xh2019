<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_D_BUDGET_ITEM_Param.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_D_BUDGET_ITEM_Param" %>
	                ...
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<tr>
								...
								<td>
									<Com:ComDropDownList ID="ddlQueryBUDGET_YEAR" Enabled="false" runat="server" ></Com:ComDropDownList>
								</td>
							</tr>
							<tr>
								<td>
