<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_EXPENSE_D.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_EXPENSE_D" %>
...
<head runat="server">
	...
	<title>BGT_B_DEPT_EXPENSE_D</title>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        ...
	        <tr>
	            <td>
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<asp:BoundField DataField="SUMARRY" HeaderText="摘要" /> 
				...
				<tr>
					...
					<td>
						<Com:ComTextBox ID="txtInputPAY_MONEY" runat="server" ></Com:ComTextBox>
