<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_BUDGET_CONTROL_D.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_BUDGET_CONTROL_D" %>
...
<head runat="server">
	...
	<title>BGT_B_BUDGET_CONTROL_D</title>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        ...
	        <tr>
	            <td>
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<asp:BoundField DataField="TYPE_ID_NAME" HeaderText="控制类型" /> 
							<asp:BoundField DataField="ITEM_ID_NAME" HeaderText="预算科目" /> 
							<asp:BoundField DataField="EDITION_ID_NAME" HeaderText="控制版本" /> 
													</Columns>
				...
				<tr>
					...
					<td>
						<Com:ComDropDownList ID="ddlInputEDITION_ID" runat="server" ></Com:ComDropDownList>
					</td>
				</tr>				
												</table>
											</div>
