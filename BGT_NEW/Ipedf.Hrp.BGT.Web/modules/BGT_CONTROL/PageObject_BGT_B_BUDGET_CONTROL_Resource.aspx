<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_BUDGET_CONTROL_Resource.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_BUDGET_CONTROL_Resource" %>
...
<form id="form1" runat="server">
	<div>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        ...
	        <tr>
                <td align="right">
                    <nobr>科目名称:</nobr><Com:ComTextBox runat="server" ID="txtQueryKey" ></Com:ComTextBox><asp:ImageButton runat="server" ID="btnSearch" ImageUrl="../../images/action/zoom.gif" OnClick="OnQuery" />
                </td>
            </tr>
	        <tr>
	            <td>
