<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_BUDGET_CONTROL.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_BUDGET_CONTROL" %>
...
<head id="Head1" runat="server">
	...
	<title>BGT_B_BUDGET_CONTROL</title>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				     <tr >
						...
						<td>
							...
							<asp:BoundField DataField="CODE" HeaderText="管控文号" /> 
							<asp:BoundField DataField="CREATE_DATE" HeaderText="发布日期" DataFormatString="{0:yyyy-MM-dd}"/> 
				...
				<tr>
					...
					<td>
						<Com:ComTextBox ID="txtInputCODE" runat="server" MaxLength = "50" ></Com:ComTextBox>
							...
							<asp:TemplateField HeaderText="控制类型">
								<ItemTemplate>
									<Com:ComDropDownList ID="ddlInputTYPE_ID" runat="server" ></Com:ComDropDownList>
								</ItemTemplate>
							</asp:TemplateField>
							<asp:TemplateField HeaderText="浮动比例">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputSLIDING_SCALES" runat="server"  Width="20"  MaxLength="2" /> %
								</ItemTemplate>
							</asp:TemplateField>
							<asp:TemplateField HeaderText="控制版本">
								<ItemTemplate>
									<Com:ComDropDownList ID="ddlInputEDITION_ID" runat="server" ></Com:ComDropDownList><input type="textbox" style="width:40px;" onkeyup="SearchValue(this,document.getElementById('ddlInputEDITION_ID'));" />
								</ItemTemplate>
							</asp:TemplateField>                     
																			</Columns>
																			<HeaderStyle CssClass="HeaderStyle"></HeaderStyle>
							...
							<Com:ComDropDownList ID="ddlDataSourceTYPE_ID" runat="server" Visible="false"/>
							<Com:ComDropDownList ID="ddlDataSourceITEM_ID" runat="server" Visible="false"/>
							<Com:ComDropDownList ID="ddlDataSourceEDITION_ID" runat="server" Visible="false"/>
																	</td>
																</tr>
																<tr>
                                                                        <td>
                                                                            <a href="../../Template/bgt/PageObject_BGT_B_BUDGET_CONTROL.xls" onclick="javascript:void(0);"
