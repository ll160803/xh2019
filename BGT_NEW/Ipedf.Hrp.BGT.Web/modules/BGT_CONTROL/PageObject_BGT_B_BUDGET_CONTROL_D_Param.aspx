<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_BUDGET_CONTROL_D_Param.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_BUDGET_CONTROL_D_Param" %>
	                ...
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<tr>
								...
								<td>
									<Com:ComDropDownList ID="ddlQueryEDITION_ID" runat="server" ></Com:ComDropDownList>
								</td>
							</tr>
												</table>
											</div>
