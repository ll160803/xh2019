<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_PLAN_MON_FACT.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_PLAN_MON_FACT" %>
...
<head id="Head1" runat="server">
	...
	<title>BGT_B_DEPT_PLAN_MON_FACT</title>
           ...
           <tr >
				...
				<tr>
					...
					<td colspan=2>&nbsp;</td>
							...
							<asp:BoundField DataField="ITEM_ID_NAME" HeaderText="指标名称" /> 
							<asp:BoundField DataField="UNIT_ID_NAME" HeaderText="计量单位" />
							<asp:TemplateField HeaderText="执行数量">
								<ItemTemplate>
							...
							<Com:ComDropDownList ID="ddlDataSourceSOURCE_TYPE_ID" runat="server" Visible="false"/>
																...
																<tr>
                                                                        <td>
                                                                            <a href="../../Template/bgt/PageObject_BGT_B_DEPT_PLAN_MON_FACT.xls" onclick="javascript:void(0);"
