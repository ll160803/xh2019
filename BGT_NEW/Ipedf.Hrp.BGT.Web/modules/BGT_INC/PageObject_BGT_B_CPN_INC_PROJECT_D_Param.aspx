<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_CPN_INC_PROJECT_D_Param.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_CPN_INC_PROJECT_D_Param" %>
	                ...
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<tr>
								...
								<td>
									<Com:ComTextBox ID="txtQueryITEM_NAME" runat="server" MaxLength = "500" ></Com:ComTextBox>
								</td>
							</tr>
							<tr>
								<td>
