<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_INC_YEAR_D.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_INC_YEAR_D" %>
	            ...
	            <td>
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<asp:BoundField DataField="ITEM_VALUE" HeaderText="科目值" /> 
													</Columns>
