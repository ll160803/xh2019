<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_CPN_INC_PERSON_FEE.aspx.cs"
    Inherits="Ipedf.Web.PageObject_BGT_B_CPN_INC_PERSON_FEE" %>
...
<head id="Head1" runat="server">
    ...
    <title>BGT_B_CPN_INC_PERSON_FEE</title>
                                                            ...
                                                            <div id="basePannel" runat="server">
                                                                <table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <Com:ComTextBox ID="txtInputNAME" Text="人员经费" Enabled="false" runat="server" MaxLength="100"></Com:ComTextBox>
                                                                        </td>
                                                                        <td>
                                                                            <nobr>金额</nobr>
                                                                        </td>
