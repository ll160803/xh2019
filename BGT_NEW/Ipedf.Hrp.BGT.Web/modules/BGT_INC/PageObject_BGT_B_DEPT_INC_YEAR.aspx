<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_DEPT_INC_YEAR.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_DEPT_INC_YEAR" %>
...
<head id="Head1" runat="server">
	...
	<title>BGT_B_DEPT_INC_YEAR</title>
				...
				<tr>
					...
					<td>
						<Com:ComBaseBox ID="ddlInputBUDGET_DEPT_ID" runat="server" ></Com:ComBaseBox>
							...
							<asp:TemplateField HeaderText="科目值">
								<ItemTemplate>
							...
							<Com:ComDropDownList ID="ddlDataSourceITEM_ID" runat="server" Visible="false"/>
																...
																<tr>
                                                                        <td>
                                                                            <a href="../../Template/bgt/PageObject_BGT_B_CPN_INC_YEAR.xls" onclick="javascript:void(0);"
