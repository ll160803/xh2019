<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_CPN_INC_PERSON_FEE_D_Param.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_CPN_INC_PERSON_FEE_D_Param" %>
...
<head runat="server">
	...
	<title>BGT_B_CPN_INC_PERSON_FEE_D</title>
	                ...
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<tr>
								...
								<td>
									<Com:ComBaseBox ID="ddlQueryBUDGRT_ITEM_ID" runat="server" ></Com:ComBaseBox>
								</td>
							</tr>
							<tr>
								<td>
