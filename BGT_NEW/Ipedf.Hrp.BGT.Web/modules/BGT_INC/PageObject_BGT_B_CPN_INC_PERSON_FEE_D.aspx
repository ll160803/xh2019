<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_CPN_INC_PERSON_FEE_D.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_CPN_INC_PERSON_FEE_D" %>
	            ...
	            <td>
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<asp:BoundField DataField="BUDGRT_ITEM_ID_NAME" HeaderText="经费名称" /> 
