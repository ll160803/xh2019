<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_CPN_INC_PROJECT.aspx.cs"
    Inherits="Ipedf.Web.PageObject_BGT_B_CPN_INC_PROJECT" %>
...
<head id="Head1" runat="server">
    ...
    <title>BGT_B_CPN_INC_PROJECT</title>
                                                            ...
                                                            <div id="basePannel" runat="server">
                                                                <table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <Com:ComTextBox ID="txtInputNAME" Text="项目支出" Enabled="false" runat="server" MaxLength="100"></Com:ComTextBox>
                                                                        </td>
                                                                        <td>
                                                                            <nobr>金额</nobr>
                                                                        </td>
                                                                        <td>
                                                                            <Com:ComTextBox ID="txtInputTotalMONEY" Enabled="false" runat="server"></Com:ComTextBox>
                                                                            <asp:RegularExpressionValidator ID="revtxtInputTotalMONEY" runat="server" ControlToValidate="txtInputTotalMONEY"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="5">
                                                                            <Com:ComTextBox ID="txtInputDECALRE_CAUSE" runat="server" TextMode="MultiLine" Columns="20"
                                                                                Rows="2" Font-Size="12px" Width="96%" Height="35px" MaxLength="2000"></Com:ComTextBox>
                                                                        </td>
                                                                    </tr>
                                                                            ...
                                                                            <Com:ComGridView ID="gvDetailList" runat="server" AutoGenerateColumns="False" BorderColor="#b5d6e6"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="项目名称">
                                                                                        <ItemTemplate>
                                                                                            <Com:ComTextBox ID="txtInputITEM_NAME" runat="server"></Com:ComTextBox>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
