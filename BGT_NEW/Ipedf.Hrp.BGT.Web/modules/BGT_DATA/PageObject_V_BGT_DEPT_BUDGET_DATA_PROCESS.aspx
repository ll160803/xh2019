<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_V_BGT_DEPT_BUDGET_DATA_PROCESS.aspx.cs" Inherits="Ipedf.Web.PageObject_V_BGT_DEPT_BUDGET_DATA_PROCESS" %>
	            ...
	            <td>
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<asp:BoundField DataField="CREATE_DATE" HeaderText="" DataFormatString="{0:yyyy-MM-dd}"/> 
							<asp:BoundField DataField="DEPT_ID" HeaderText="" /> 
													</Columns>
