<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_BUDGET_DATA_DEPT.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_BUDGET_DATA_DEPT" %>
...
<head runat="server">
	...
	<title>BGT_B_BUDGET_DATA_DEPT</title>
	            ...
	            <td>
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
							...
							<asp:TemplateField HeaderText="预算科室">
								<ItemTemplate>
							...
							<asp:TemplateField HeaderText="创建日期">
								<ItemTemplate>
									<Com:ComTextBox ID="txtInputCREATE_DATE" runat="server" ></Com:ComTextBox><img style="cursor: hand" onclick="tableClick(this)" src="../../images/calender.gif" >
								</ItemTemplate>
							</asp:TemplateField>     
												</Columns>
