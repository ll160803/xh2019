<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageObject_BGT_B_BUDGET_DATA_3.aspx.cs" Inherits="Ipedf.Web.PageObject_BGT_B_BUDGET_DATA_3" %>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr >
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				     <tr >
						...
						<td>
							...
							<asp:BoundField DataField="TEMPLET_ID_NAME" HeaderText="预算模板" /> 
				...
				<tr>
					...
					<td>
						<Com:ComBaseBox ID="ddlInputTEMPLET_ID" runat="server" ></Com:ComBaseBox>
					</td>
					<td >
						<nobr>预算年度</nobr>
					</td>
													...
													<tr>
														<td >
															...
															<table border="1" bordercolordark="#FFFFFF" bordercolorlight="#b5d6e6" cellSpacing="0" cellPadding="0">	
															    ...
															    <tr>
															        <td>
															            <Com:ComButton runat="server" ID="btnUndoSubmit" Text="打回" OnClick="DeptBudgetDataUndoSubmit" />
															        </td>
															    </tr>
																<tr>
																    <td>
																        <Com:ComGridView ID="gvDeptList" runat="server" AutoGenerateColumns="False"   BorderColor="#b5d6e6" BorderWidth="1px"  AllowPaging="True"  AllowSorting="True" BorderStyle="Double" DbClickEdit="false" >
													                        <Columns>    
													                            <asp:TemplateField HeaderText="V">
																					<headertemplate>
																							<INPUT id="chkSelItem" type="checkbox" onclick="selectAll('gvDeptList');" />
																					</headertemplate>
																					<ItemTemplate>
																						<asp:CheckBox ID="cbSelect" runat="server" />
																					</ItemTemplate>
							                                                    ...
							                                                    <asp:BoundField DataField="STATUS" HeaderText="提交状态" /> 
							                                                    <asp:BoundField DataField="CREATE_DATE" HeaderText="提交日期" DataFormatString="{0:yyyy-MM-dd}"/>							                                                
							                                                </Columns>
							                                                <HeaderStyle CssClass="HeaderStyle"></HeaderStyle>
							                                                <FooterStyle CssClass="FooterStyle"></FooterStyle>                            
							                                                <RowStyle CssClass="RowStyle"></RowStyle>
																	...
																	<td>
																		<Com:ComGridView ID="gvDetailList" runat="server" AutoGenerateColumns="False" BorderColor="#b5d6e6" BorderWidth="1px" DbClickEdit="false">
																			<Columns>
							                                                    ...
							                                                    <asp:BoundField DataField="CPN_VALUE" HeaderText="全院" /> 	
							                                                    <asp:BoundField DataField="DEPT_VALUE" HeaderText="科室汇总" /> 	
							                                                    <asp:BoundField DataField="DIFF_VALUE" HeaderText="差异" /> 				                                                  
														                    </Columns>
																			<HeaderStyle CssClass="HeaderStyle"></HeaderStyle>
																			<FooterStyle CssClass="FooterStyle"></FooterStyle>                            
																			<RowStyle CssClass="RowStyle"></RowStyle>
