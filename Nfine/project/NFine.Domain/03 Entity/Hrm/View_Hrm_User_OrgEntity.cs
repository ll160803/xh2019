...
{
    /// <summary>
    /// View_Hrm_User_Org Entity Model
    /// </summary>
    public class View_Hrm_User_OrgEntity : IEntity<View_Hrm_User_OrgEntity>, ICreationAudited, IDeleteAudited, IModificationAudited
    {
